	...
	public Collection findReportData(ReportVO report, Object criteria)
		...
		try {
			...
			if (report.getReportCode().equals("700046")) {
				...
				lSBQuery.append(" Select EM.DCPS_ID ,EM.EMP_NAME ,TR.CONTRIBUTION ,TR.TYPE_OF_PAYMENT ,VC.voucher_no ,VC.voucher_date ,TR.DDO_CODE ,TR.DCPS_EMP_ID ,TR.EMPLOYER_CONTRI_FLAG ,VC.emplr_voucher_no , VC.emplr_voucher_date emplrVoucherDate ");
