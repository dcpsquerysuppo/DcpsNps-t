...
public class NsdlNpsFileEmpWiseReport extends DefaultReportDataFinder {
    ...
    throws ReportException {
		...
		StyleVO[] CenterBoldAlignVO12 = new StyleVO[4];
		CenterBoldAlignVO12[0] = new StyleVO();
		CenterBoldAlignVO12[0].setStyleId(IReportConstants.STYLE_FONT_ALIGNMENT);
		CenterBoldAlignVO12[0].setStyleValue(IReportConstants.VALUE_FONT_ALIGNMENT_CENTER);
		CenterBoldAlignVO12[1] = new StyleVO();
		CenterBoldAlignVO12[1].setStyleId(IReportConstants.BORDER);
		CenterBoldAlignVO12[1].setStyleValue(IReportConstants.VALUE_STYLE_BORDER_NONE);
		CenterBoldAlignVO12[2] = new StyleVO();
		//CenterBoldAlignVO[2].setStyleId(IReportConstants.STYLE_FONT_SIZE);
		//	CenterBoldAlignVO[2].setStyleValue("12");
		CenterBoldAlignVO12[2].setStyleValue(IReportConstants.VALUE_FONT_WEIGHT_BOLD);
		CenterBoldAlignVO12[2].setStyleId(IReportConstants.STYLE_FONT_WEIGHT);
		CenterBoldAlignVO12[3] = new StyleVO();
		CenterBoldAlignVO12[3].setStyleId(IReportConstants.STYLE_FONT_SIZE);
		CenterBoldAlignVO12[3].setStyleValue("14");
...
*/            
            ...
            if (report.getReportCode().equals("80000963")) {
               ...
               while(rs.next()) {
                    ...
                    for (int j = 0; j < lstLoopingForTierII.size(); ++j) {
                       ...
                       if(tupleSub6[0].toString().equals("34")){
                        ...
                        dataList.add(td);
                    	  ...
                    	  if(tupleSub6[0].toString().equals("36")){
                              td.add(new StyledData(Math.round(Total),boldVO));
                              td.add(new StyledData(Math.round(Interest),boldVO));
                              PayableTotal2 += Math.round(Interest);
                              closingBalance = (double) (Math.round(Interest) + Math.round(Total));
                              td.add(new StyledData(EmployeeDetails,boldVO));
                              //td.add(EmployeeDetails);
                              td.add(new StyledData(Math.round(closingBalance),CenterBoldAlignVO12));
                              openingBalance = (double) Math.round(closingBalance);
                              dataList.add(td);
                              }else{
                              	 td.add(new StyledData(Total,boldVO));
                ...
                final ReportAttributeVO[] lArrrReportAttributeVO2 = new ReportAttributeVO[9];
                ...
                lArrrReportAttributeVO2[2].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.NEWLINE"), CenterBoldAlignVO2) + "<br> <br>"));
                ...
                lArrrReportAttributeVO2[3].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.NEWLINE"), CenterBoldAlignVO2) + "<br> <br>"));
                ...
                lArrrReportAttributeVO2[4].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.NEWLINE"), CenterBoldAlignVO2) + "<br> <br>"));
                ...
                lArrrReportAttributeVO2[5].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.NEWLINE"), CenterBoldAlignVO2) + "<br> <br>"));*/
                (lArrrReportAttributeVO2[4] = new ReportAttributeVO()).setAttributeType(7);
                lArrrReportAttributeVO2[4].setLocation(2);
                lArrrReportAttributeVO2[4].setAlignment(4);
                lArrrReportAttributeVO2[4].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.BOTTOM1")+space(30), CenterBoldAlignVO2) + "<br> <br>  "));
                (lArrrReportAttributeVO2[5] = new ReportAttributeVO()).setAttributeType(7);
                lArrrReportAttributeVO2[5].setLocation(2);
                lArrrReportAttributeVO2[5].setAlignment(4);
                lArrrReportAttributeVO2[5].setAttributeValue((Object)(new StyledData((Object)DesignationName2+space(23), CenterBoldAlignVO2) + "<br> <br>"));
                ...
                lArrrReportAttributeVO2[6].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.BOTTOM2")+space(23), CenterBoldAlignVO2) + "<br> <br>  "));
                (lArrrReportAttributeVO2[7] = new ReportAttributeVO()).setAttributeType(7);
                lArrrReportAttributeVO2[7].setLocation(2);
                lArrrReportAttributeVO2[7].setAlignment(4);
                lArrrReportAttributeVO2[7].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.BOTTOM3")+space(30), CenterBoldAlignVO2) + "<br> <br>  "));
                ...
                (lArrrReportAttributeVO2[8] = new ReportAttributeVO()).setAttributeType(7);
                lArrrReportAttributeVO2[8].setLocation(2);
                lArrrReportAttributeVO2[8].setAlignment(4);
                lArrrReportAttributeVO2[8].setAttributeValue((Object)(new StyledData((Object)DDOCODE3+space(21), CenterBoldAlignVO2) + "<br> <br>  "));
                ...
                final StyleVO[] CenterBoldAlignVO15 = new StyleVO[4];
                (CenterBoldAlignVO15[0] = new StyleVO()).setStyleId(40);
                CenterBoldAlignVO15[0].setStyleValue("center");
                (CenterBoldAlignVO15[1] = new StyleVO()).setStyleId(1);
                CenterBoldAlignVO15[1].setStyleValue("none");
                (CenterBoldAlignVO15[2] = new StyleVO()).setStyleValue("bold");
                CenterBoldAlignVO15[2].setStyleId(37);
                (CenterBoldAlignVO15[3] = new StyleVO()).setStyleId(38);
                CenterBoldAlignVO15[3].setStyleValue("12");
                ...
                if(Type.equals("700002")||Type.equals("100018")){////ddo login
                final ReportAttributeVO[] lArrrReportAttributeVO = new ReportAttributeVO[11];
                ...
                lArrrReportAttributeVO[2].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.NEWLINE"), CenterBoldAlignVO) + "<br> <br>"));
                ...
                lArrrReportAttributeVO[3].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.NEWLINE"), CenterBoldAlignVO) + "<br> <br>"));
                ...
                lArrrReportAttributeVO[4].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.NEWLINE"), CenterBoldAlignVO) + "<br> <br>"));
                ...
                lArrrReportAttributeVO[5].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.NEWLINE"), CenterBoldAlignVO) + "<br> <br>"));
                ...
                lArrrReportAttributeVO[6].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.BOTTOM1")+space(30), CenterBoldAlignVO15) + "<br> <br>"));
                (lArrrReportAttributeVO[7] = new ReportAttributeVO()).setAttributeType(7);
                lArrrReportAttributeVO[7].setLocation(2);
                lArrrReportAttributeVO[7].setAlignment(4);
                /*if(Type.equals("100018"))
                ...
                lArrrReportAttributeVO[7].setAttributeValue((Object)(new StyledData((Object)DesignationName+space(30), CenterBoldAlignVO) + "<br> <br>"));
                
                (lArrrReportAttributeVO[8] = new ReportAttributeVO()).setAttributeType(7);
                lArrrReportAttributeVO[8].setLocation(2);
                lArrrReportAttributeVO[8].setAlignment(4);
                lArrrReportAttributeVO[8].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.BOTTOM2")+space(23), CenterBoldAlignVO) + "<br> <br>  "));
                (lArrrReportAttributeVO[9] = new ReportAttributeVO()).setAttributeType(7);
                lArrrReportAttributeVO[9].setLocation(2);
                lArrrReportAttributeVO[9].setAlignment(4);
                lArrrReportAttributeVO[9].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.BOTTOM3")+space(30), CenterBoldAlignVO) + "<br> <br>  "));
                ...
                lArrrReportAttributeVO[10].setLocation(2);
                lArrrReportAttributeVO[10].setAlignment(4);
                lArrrReportAttributeVO[10].setAttributeValue((Object)(new StyledData((Object)DDOCODE+space(22), CenterBoldAlignVO) + "<br> <br>  "));
                ...
                report.setReportAttributes(lArrrReportAttributeVO);
                    ...
                    lArrrReportAttributeVO[4].setLocation(2);
                    lArrrReportAttributeVO[4].setAlignment(4);
                    lArrrReportAttributeVO[4].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.BOTTOM1")+space(30), CenterBoldAlignVO15) + "<br> <br>"));
                    (lArrrReportAttributeVO[5] = new ReportAttributeVO()).setAttributeType(7);
                    lArrrReportAttributeVO[5].setLocation(2);
                    lArrrReportAttributeVO[5].setAlignment(4);
                    if(DdoCOde2.substring(0, 4).equals("7101")){
                    lArrrReportAttributeVO[5].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("GG.headerB2TO")+space(20)+ "<br> <br> "+gObjRsrcBndleForSPL90.getString("GG.headerB3TO")+space(29), CenterBoldAlignVO15)+ "<br> <br>"));
                    }else{
                    lArrrReportAttributeVO[5].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("GG.headerB1TO")+space(24), CenterBoldAlignVO15) + "<br> <br>"));
                    }
                    	
                    (lArrrReportAttributeVO[6] = new ReportAttributeVO()).setAttributeType(7);
                    lArrrReportAttributeVO[6].setLocation(2);
                    lArrrReportAttributeVO[6].setAlignment(4);
                    lArrrReportAttributeVO[6].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("FF.BOTTOM3")+space(29), CenterBoldAlignVO15) + "<br> <br>"));
		...
		try {
			...
			for (Iterator iterator = lstRateOfInterest.iterator(); iterator.hasNext();) {
				...
				if(financialYear.equals("34")){
			        ...
			        Date d1 = sdformat.parse(letterDate);
					...
					finslInt=finslInt+Double.parseDouble(new DecimalFormat("##.##").format((12*0.071*(openingBalance+installmentAmt))/12));
						...
						if(financialYear.equals("35")){
							...
							if(Integer.valueOf(val[0])<15 )
							finslInt=finslInt+Double.parseDouble(new DecimalFormat("##.##").format((0.071*openingBalance*(months-4))/12));//apr-oct 7
							else
							finslInt=finslInt+Double.parseDouble(new DecimalFormat("##.##").format((0.071*openingBalance*(months-4))/12));//apr-nov 8
						}else{
							if(interestDays==366)
...
*/    
    ...
    public String getLetterCreatedDate(final String orderId,String dcps_Emp_id, String from) throws Exception {
        ...
        try {
                ...
                sb = new StringBuilder();
                sb.append(" select to_char(CREATED_DATE,'dd/MM/yyyy') from TIERII_NAMUMNA_F_EMP_DETAILS ");
                sb.append(" where BILLL_ID like '" + orderId.substring(0, 12) + "%' and DCPS_ID='"+letterDate+"' and STATUS <> '-1' order by CREATED_DATE desc FETCH first ROW only ");
                ghibSession = (Session)ServiceLocator.getServiceLocator().getSessionFactorySlave().getCurrentSession();
                lQuery = (Query)ghibSession.createSQLQuery(sb.toString());
                letterDate = (String) lQuery.list().get(0);
            	}
