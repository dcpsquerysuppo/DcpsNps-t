...
public class TierIIReport extends DefaultReportDataFinder implements ReportDataFinder {
	...
	public Collection findReportData(ReportVO report, Object criteria) throws ReportException {
		...
		try {
	        ...
	        String deputation = (String) report.getParameterValue("deputation");
                ...
                rowList.add(new StyledData(MessageFormat.format(gObjRsrcBndleForSPL90.getString("DFF.VISHAY"),""), leftBoldAlignVO));
                dataList11.add(rowList);
                rowList = new ArrayList();
                ...
                dataList11.add(rowList);
                rowList = new ArrayList();
                rowList.add(new StyledData(MessageFormat.format(gObjRsrcBndleForSPL90.getString("FF.BOTTOM")+space(27),""), rightAlign));
                dataList11.add(rowList);
                rowList = new ArrayList();
                rowList.add(new StyledData(MessageFormat.format(gObjRsrcBndleForSPL90.getString("FF.NEWLINE"),""), rightAlign));
                dataList11.add(rowList);
                rowList = new ArrayList();
                rowList.add(new StyledData(MessageFormat.format(gObjRsrcBndleForSPL90.getString("FF.NEWLINE"),""), rightAlign));
                dataList11.add(rowList);
               ...
               /* if (Type.equalsIgnoreCase("700002")) {
                ...
                dataList11.add(rowList);
      	        ...
      	        String Type = (String)report.getParameterValue("type");
                    ...
                    rowList.add(new StyledData(MessageFormat.format(gObjRsrcBndleForSPL90.getString("DFFTO.VISHAY1"),"")+gObjRsrcBndleForSPL90.getString("DFFTO.VISHAY2"), leftBoldAlignVO));
                    dataList11.add(rowList);
                    rowList = new ArrayList<Object>();
                    rowList.add(newline);
                    dataList11.add(rowList);
					...
					rowList4 = new ArrayList<Object>();
					rowList4.add(new StyledData(gObjRsrcBndleForSPL90.getString("RH.ADESH8"), leftAlign));
					dataList11.add(rowList4);*/
                    ...
                    if (!deputation.equals("Y")){
        				...
        				lObjHomePageStyleList[0].setStyleId(IReportConstants.ALIGN_LEFT);
        				...
        				report.addReportStyles(lObjHomePageStyleList);*/
                    	lArrrReportAttributeVO = new ReportAttributeVO[17];
                    	(lArrrReportAttributeVO[0] = new ReportAttributeVO()).setAttributeType(7);
                        ...
                        lArrrReportAttributeVO[1].setLocation(IReportConstants.LOCATION_FOOTER);
                        lArrrReportAttributeVO[1].setAlignment(IReportConstants.ALIGN_LEFT);
                        lArrrReportAttributeVO[1].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("RH.ADESH9"), CenterBoldAlignVO) + "<br>"));
                        (lArrrReportAttributeVO[2] = new ReportAttributeVO()).setAttributeType(7);
                        lArrrReportAttributeVO[2].setLocation(IReportConstants.LOCATION_FOOTER);
                        lArrrReportAttributeVO[2].setAlignment(IReportConstants.ALIGN_LEFT);
                        lArrrReportAttributeVO[2].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("RH.ADESH10"), CenterBoldAlignVO) + "<br>"));
                        (lArrrReportAttributeVO[3] = new ReportAttributeVO()).setAttributeType(7);
                        lArrrReportAttributeVO[3].setLocation(IReportConstants.LOCATION_FOOTER);
                        lArrrReportAttributeVO[3].setAlignment(IReportConstants.ALIGN_LEFT);
                        lArrrReportAttributeVO[3].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("RH.ADESH11"), CenterBoldAlignVO) + "<br>"));
                        (lArrrReportAttributeVO[4] = new ReportAttributeVO()).setAttributeType(7);
                        lArrrReportAttributeVO[4].setLocation(IReportConstants.LOCATION_FOOTER);
                        lArrrReportAttributeVO[4].setAlignment(IReportConstants.ALIGN_LEFT);
                        lArrrReportAttributeVO[4].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("RH.ADESH12"), CenterBoldAlignVO) + "<br>"));
                        (lArrrReportAttributeVO[5] = new ReportAttributeVO()).setAttributeType(7);
                        lArrrReportAttributeVO[5].setLocation(IReportConstants.LOCATION_FOOTER);
                        lArrrReportAttributeVO[5].setAlignment(IReportConstants.ALIGN_LEFT);
                        lArrrReportAttributeVO[5].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("RH.ADESH13"), CenterBoldAlignVO) + "<br> <br>"));
                        ...
                        lArrrReportAttributeVO[10].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("DRH.FOOTER1"), CenterBoldAlignVO) + "<br>"));
                        (lArrrReportAttributeVO[11] = new ReportAttributeVO()).setAttributeType(7);
                        lArrrReportAttributeVO[11].setLocation(IReportConstants.LOCATION_FOOTER);
                        lArrrReportAttributeVO[11].setAlignment(IReportConstants.ALIGN_RIGHT);
                        lArrrReportAttributeVO[11].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("RH.FOOTER2")+space(30), CenterBoldAlignVO) + "<br> <br>  "));
                        (lArrrReportAttributeVO[12] = new ReportAttributeVO()).setAttributeType(7);
                        lArrrReportAttributeVO[12].setLocation(IReportConstants.LOCATION_FOOTER);
                        lArrrReportAttributeVO[12].setAlignment(IReportConstants.ALIGN_LEFT);
                        lArrrReportAttributeVO[12].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("RH.PRATI"), CenterBoldAlignVO) + "<br> "));
                        (lArrrReportAttributeVO[13] = new ReportAttributeVO()).setAttributeType(7);
                        lArrrReportAttributeVO[13].setLocation(IReportConstants.LOCATION_FOOTER);
                        lArrrReportAttributeVO[13].setAlignment(IReportConstants.ALIGN_LEFT);
                        lArrrReportAttributeVO[13].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("DRH.PRATI2"), CenterBoldAlignVO) + "<br> "));
                        (lArrrReportAttributeVO[14] = new ReportAttributeVO()).setAttributeType(7);
                        lArrrReportAttributeVO[14].setLocation(IReportConstants.LOCATION_FOOTER);
                        lArrrReportAttributeVO[14].setAlignment(IReportConstants.ALIGN_LEFT);
                        lArrrReportAttributeVO[14].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("DRH.PRATI3"), CenterBoldAlignVO) + "<br> "));
                        ...
                        lArrrReportAttributeVO[15].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("DRH.PRATI4"), CenterBoldAlignVO) + "<br> "));
                        ...
                        lArrrReportAttributeVO[16].setAttributeValue((Object)(new StyledData((Object)gObjRsrcBndleForSPL90.getString("DRH.PRATI5"), CenterBoldAlignVO) + "<br> "));
                    }
                    final String lStrRptName = report.getReportName();
                    report.setReportAttributes(lArrrReportAttributeVO);
                }else if (report.getReportCode().equals("800009628")) {
                	String tierIISummaryFlag = StringUtility.getParameter("tierIISummaryFlag", request).trim();
    				...
    				if(tierIISummaryFlag.equals("T")){
    				List allTreasury=getTreasury();
    				for (int i=0;i<allTreasury.size();i++)
    				{	
    					Object[] tupleSub = (Object[]) allTreasury.get(i);
    				    
    				    rowList = new ArrayList();
    					rowList.add(i+1);
    					rowList.add(tupleSub[1].toString());
    					
    					int valA= getTierIIEmpRefundRequestedCount(tupleSub[0].toString().trim(),"Regular");
    					if (valA > 0) 
    					{	
    						rowList.add(valA);
    					}
    					...
    					int valB= getTierIIEmpRefundGeneratedCount(tupleSub[0].toString().trim(),"Regular");
    					if (valB > 0) 
    					{
    						rowList.add(valB);
    					}
    					...
    					int valC= getTierIIEmpRefundGeneratedBillAmt(tupleSub[0].toString().trim(),"Regular");
    					if (valC > 0) 
    					{
    						rowList.add(valC);
    					}
                ...
                }else if (report.getReportCode().equals("800009629")) {
                	String tierIISummaryFlag = StringUtility.getParameter("tierIISummaryFlag", request).trim();
                	SimpleDateFormat  dateFormat = new SimpleDateFormat("dd/MM/yyyy");	
    	            Date date = new Date();	
    	            String curDate = dateFormat.format(date);	
    				...
    				if(tierIISummaryFlag.equals("D")){
                	List allTreasury=getDDOOffice();
       				for (int i=0;i<allTreasury.size();i++)
       				{	
       					Object[] tupleSub = (Object[]) allTreasury.get(i);
       					...
       					int valA= getDDOTierIIEmpRefundRequestedCount(tupleSub[0].toString().trim(),"Regular");
       					if (valA > 0) 
       					{	
       						rowList.add(valA);
       					}
       					...
       					int valB= getDDOTierIIEmpRefundGeneratedCount(tupleSub[0].toString().trim(),"Regular");
       					if (valB > 0) 
       					{
       						rowList.add(valB);
       					}
       					...
       					Long valC= getDDOTierIIEmpRefundGeneratedBillAmt(tupleSub[0].toString().trim(),"Regular");
       					if (valC > 0) 
       					{
       						rowList.add(valC);
       					}
                ...
                }else if (report.getReportCode().equals("800009630")) {
                	String tierIISummaryFlag = StringUtility.getParameter("tierIISummaryFlag", request).trim();
                	SimpleDateFormat  dateFormat = new SimpleDateFormat("dd/MM/yyyy");	
    	            Date date = new Date();	
    	            String curDate = dateFormat.format(date);	
    				...
    				List TableData = null;
    				StringBuilder SBQuery = new StringBuilder();
    				String yearMonth=getDeptYearMonth();
    				...
    				{	
    					...
    					int valA= getTierIIEmpRefundRequestedCount(tupleSub[0].toString().trim(),"Deputation-"+yearMonth);
    					if (valA > 0) 
    					{	
    						rowList.add(valA);
    					}
    					...
    					int valB= getTierIIEmpRefundGeneratedCount(tupleSub[0].toString().trim(),"Deputation-"+yearMonth);
    					if (valB > 0) 
    					{
    						rowList.add(valB);
    					}
    					...
    					int valC= getTierIIEmpRefundGeneratedBillAmt(tupleSub[0].toString().trim(),"Deputation-"+yearMonth);
    					if (valC > 0) 
    					{
    						rowList.add(valC);
    					}
                ...
                }else if (report.getReportCode().equals("800009634")) {
                	String tierIISummaryFlag = StringUtility.getParameter("tierIISummaryFlag", request).trim();
                	String startDate = StringUtility.getParameter("startDate", request).trim();
                	String endDate = StringUtility.getParameter("endDate", request).trim();
                	SimpleDateFormat  dateFormat = new SimpleDateFormat("dd-mm-yyyy");	
    	            Date date = new Date();
    	            String curDate = dateFormat.format(date);	
    	            gLogger.info("=====Innside parent report=====");	
    	            String header5 = this.space(5) + "From :- " + this.space(2) + startDate+ this.space(5) + "To :- " +endDate;	
    	            report.setAdditionalHeader(header5);
    				List TableData = null;
    				StringBuilder SBQuery = new StringBuilder();
    				...
    				{	
    					...
    					int valB= getTierIIEmpRefundGeneratedCountPeriod(tupleSub[0].toString().trim(),"Regular",startDate,endDate);
    					if (valB > 0) 
    					{
    						rowList.add(valB);
    					}
    					...
    					int valC= getTierIIEmpRefundGeneratedBillAmtPeriod(tupleSub[0].toString().trim(),"Regular",startDate,endDate);
    					if (valC > 0) 
    					{
    						rowList.add(valC);
    					}
                ...
                }else if (report.getReportCode().equals("800009635")) {
                	String tierIISummaryFlag = StringUtility.getParameter("tierIISummaryFlag", request).trim();
                	String startDate = StringUtility.getParameter("startDate", request).trim();
                	String endDate = StringUtility.getParameter("endDate", request).trim();
    	            gLogger.info("=====Innside parent report=====");	
                	...
                	List allTreasury=getDDOOffice();
       				...
       				{	
       					...
       					int valB= getDDOTierIIEmpRefundGeneratedCountPeriod(tupleSub[0].toString().trim(),"Regular",startDate,endDate);
       					if (valB > 0) 
       					{
       						rowList.add(valB);
       					}
       					...
       					Long valC= getDDOTierIIEmpRefundGeneratedBillAmtPeriod(tupleSub[0].toString().trim(),"Regular",startDate,endDate);
       					if (valC > 0) 
       					{
       						rowList.add(valC);
       					}
                ...
                }else if (report.getReportCode().equals("800009636")) {
                	String tierIISummaryFlag = StringUtility.getParameter("tierIISummaryFlag", request).trim();
                	String startDate = StringUtility.getParameter("startDate", request).trim();
                	String endDate = StringUtility.getParameter("endDate", request).trim();
    	            gLogger.info("=====Innside parent report=====");	
    				...
    				{	
    					...
    					int valB= getTierIIEmpRefundGeneratedCountPeriod(tupleSub[0].toString().trim(),"Deputation-"+yearMonth,startDate,endDate);
    					if (valB > 0) 
    					{
    						rowList.add(valB);
    					}
    					...
    					int valC= getTierIIEmpRefundGeneratedBillAmtPeriod(tupleSub[0].toString().trim(),"Deputation-"+yearMonth,startDate,endDate);
    					if (valC > 0) 
    					{
    						rowList.add(valC);
    					}
    ...
    public String getLocationName(String locCode)
    {
        ...
        private int getTierIIEmpRefundRequestedCount(String treasury, String type) {
    		StringBuilder lSBQuery = new StringBuilder();
    		int SevarthIdList;
    		...
    		try {
    			...
    			lSBQuery.append(" SELECT COUNT(SEVARTH_ID) FROM MST_DCPS_EMP mst INNER JOIN CMN_LOCATION_MST cm on substr(mst.DDO_CODE,1,2)=substr(cm.LOC_ID,1,2) AND cm.DEPARTMENT_ID=100003 inner join org_ddo_mst o on mst.ddo_code=o.DDO_CODE inner join CMN_LOCATION_MST l1 on l1.LOCATION_CODE=o.dept_loc_code WHERE DOJ >='2005-11-01'  ");
    			lSBQuery.append(" and DOJ <='2009-03-31' and mst.EMP_SERVEND_DT >sysdate and mst.reg_status=1 and dcps_or_gpf='Y' AND mst.DDO_CODE<>'1111222222' AND  mst.dept_ddo_code is null AND  mst.ddo_code is not null ");
    			lSBQuery.append(" and substr(cm.LOC_ID,1,2)='"+treasury.substring(0, 2)+"' ");
    			}else{
    			String [] yearDate=	type.split("-");
    			lSBQuery.append(" SELECT count(DISTINCT m.DCPS_EMP_ID) FROM MST_DCPS_EMP m join TRN_DCPS_DEPUTATION_CONTRIBUTION t on m.DCPS_EMP_ID=t.DCPS_EMP_ID INNER JOIN CMN_LOCATION_MST cm on substr(t.loc_id,1,2)=substr(cm.LOC_ID,1,2)  ");
        		lSBQuery.append(" AND cm.DEPARTMENT_ID=100003 WHERE (m.DOJ >='2005-11-01' and m.DOJ <='2009-03-31') and m.EMP_SERVEND_DT >sysdate and t.LOC_ID <>1111 and m.reg_status=1 and m.dcps_or_gpf='Y' and m.dcps_EMP_ID in (SELECT DISTINCT DCPS_EMP_ID FROM ");
        		lSBQuery.append(" TRN_DCPS_DEPUTATION_CONTRIBUTION where FIN_YEAR_ID='"+yearDate[1]+"' and MONTH_ID='"+yearDate[2]+"') and substr(t.loc_id,1,2)='"+treasury.substring(0, 2)+"' ");	
    			}
    			Query lQuery = neardrSession.createSQLQuery(lSBQuery.toString());
    			SevarthIdList = (int) lQuery.list().get(0);
        ...
        private int getTierIIEmpRefundGeneratedCount(String treasury, String type) {
    		StringBuilder lSBQuery = new StringBuilder();
    		int SevarthIdList;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		Session neardrSession = sessionFactory1.openSession();
    		try {
    			if(type.equalsIgnoreCase("Regular")){
    			lSBQuery.append(" SELECT count(emp.DCPS_ID) FROM TIERTWO_BILL_DTLS bill inner JOIN TIERII_EMP_DETAILS emp on bill.BILL_ID=emp.BILLL_ID AND bill.BILL_STATUS in(6,7) inner join CMN_LOCATION_MST l on   ");
    			lSBQuery.append(" substr(emp.DDO_CODE,1,2)=substr(l.LOC_ID,1,2) AND l.DEPARTMENT_ID=100003 inner join org_ddo_mst o on bill.ddo_code=o.DDO_CODE where substr(l.LOC_ID,1,2)='"+treasury.substring(0, 2)+"' ");
    			}else{
    			lSBQuery.append(" SELECT count(emp.DCPS_ID) FROM TIERTWO_BILL_DTLS bill inner JOIN TIERII_EMP_DETAILS emp on bill.BILL_ID=emp.BILLL_ID AND bill.BILL_STATUS in(16,17) inner join CMN_LOCATION_MST l on ");
        		lSBQuery.append(" substr(emp.DDO_CODE,1,2)=substr(l.LOC_ID,1,2) AND l.DEPARTMENT_ID=100003 inner join org_ddo_mst o on bill.ddo_code=o.DDO_CODE where substr(l.LOC_ID,1,2)='"+treasury.substring(0, 2)+"' ");	
    			}
    			Query lQuery = neardrSession.createSQLQuery(lSBQuery.toString());
    			SevarthIdList = (int) lQuery.list().get(0);
        ...
        private int getTierIIEmpRefundGeneratedBillAmt(String treasury, String type) {
    		StringBuilder lSBQuery = new StringBuilder();
    		List SevarthIdList;
    		int val;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		...
    		try {
    			if(type.equalsIgnoreCase("Regular")){
    			lSBQuery.append(" SELECT cast(nvl(SUM(bill.total_amount),0)as int) FROM TIERTWO_BILL_DTLS bill inner join CMN_LOCATION_MST l on substr(bill.DDO_CODE,1,2)=substr(l.LOC_ID,1,2)  ");
    			lSBQuery.append(" AND l.DEPARTMENT_ID=100003 inner join org_ddo_mst o on bill.ddo_code=o.DDO_CODE where substr(l.LOC_ID,1,2)=substr('"+treasury+"',1,2) AND bill.BILL_STATUS in(6,7) and bill.DDO_CODE<>'1111222222' ");
    			}else{
    			lSBQuery.append(" SELECT cast(nvl(SUM(bill.total_amount),0)as int) FROM TIERTWO_BILL_DTLS bill inner join CMN_LOCATION_MST l on substr(bill.DDO_CODE,1,2)=substr(l.LOC_ID,1,2) AND l.DEPARTMENT_ID=100003 inner join org_ddo_mst o ");
        		lSBQuery.append(" on bill.ddo_code=o.DDO_CODE where substr(l.LOC_ID,1,2)=substr('"+treasury+"',1,2) and bill.DDO_CODE <>'1111222222' AND bill.BILL_STATUS in(16,17) ");	
    			}
    			Query lQuery = neardrSession.createSQLQuery(lSBQuery.toString());
    			SevarthIdList = lQuery.list();
                val=(int) SevarthIdList.get(0);
    		} catch (Exception e) {
    			gLogger.error(" Error in getEmpDtls " + e, e);
    			e.printStackTrace();
    			throw e;
    	...
    	private List getTreasury() {
    		StringBuilder lSBQuery = new StringBuilder();
    		List SevarthIdList;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		Session neardrSession = sessionFactory1.openSession();
    		try {
    			lSBQuery.append(" SELECT LOC_ID,LOC_SHORT_NAME FROM CMN_LOCATION_MST where DEPARTMENT_ID =100003 and LOC_ID not in(1111,9991,99991,2028915) order by LOC_ID ");
    			Query lQuery = neardrSession.createSQLQuery(lSBQuery.toString());
    			SevarthIdList = lQuery.list();
    	...
    	private List getDDOOffice() {
    		StringBuilder lSBQuery = new StringBuilder();
    		List SevarthIdList;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		Session neardrSession = sessionFactory1.openSession();
    		try {
    			lSBQuery.append(" SELECT o.dept_loc_code,l1.loc_name FROM MST_DCPS_EMP emp INNER JOIN CMN_LOCATION_MST cm on substr(emp.DDO_CODE,1,2)=substr(cm.LOC_ID,1,2) AND cm.DEPARTMENT_ID=100003 inner join org_ddo_mst o on ");
    			lSBQuery.append(" emp.ddo_code=o.DDO_CODE inner join CMN_LOCATION_MST l1 on l1.LOCATION_CODE=o.dept_loc_code WHERE (emp.DOJ >='2005-11-01' and emp.DOJ <='2009-03-31') and emp.EMP_SERVEND_DT >sysdate and emp.reg_status=1 ");
    			//lSBQuery.append(" and emp.dcps_or_gpf='Y' AND emp.DDO_CODE<>'1111222222' AND emp.dept_ddo_code is null AND emp.ddo_code is not null and o.dept_loc_code not in ('2030983') group by o.dept_loc_code,l1.loc_name ");
    			lSBQuery.append(" and emp.dcps_or_gpf='Y' AND emp.DDO_CODE<>'1111222222' AND emp.dept_ddo_code is null AND emp.ddo_code is not null group by o.dept_loc_code,l1.loc_name ");
    	...
    	private int getDDOTierIIEmpRefundRequestedCount(String ddoOffice, String Type) {
    		StringBuilder lSBQuery = new StringBuilder();
    		int SevarthIdList;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		Session neardrSession = sessionFactory1.openSession();
    		try {
    			lSBQuery.append(" SELECT nvl(COUNT(emp.SEVARTH_ID),0) FROM MST_DCPS_EMP emp INNER JOIN CMN_LOCATION_MST cm on substr(emp.DDO_CODE,1,2)=substr(cm.LOC_ID,1,2)  ");
    			lSBQuery.append(" AND cm.DEPARTMENT_ID=100003 inner join org_ddo_mst o on emp.ddo_code=o.DDO_CODE inner join CMN_LOCATION_MST l1 on l1.LOCATION_CODE=o.dept_loc_code ");
    			lSBQuery.append(" WHERE (emp.DOJ >='2005-11-01' and emp.DOJ <='2009-03-31') and emp.EMP_SERVEND_DT >sysdate and emp.reg_status=1 and emp.dcps_or_gpf='Y' AND emp.DDO_CODE<>'1111222222' ");
    			lSBQuery.append(" AND emp.dept_ddo_code is null AND emp.ddo_code is not null and o.dept_loc_code='"+ddoOffice+"' ");
    			//lSBQuery.append(" AND emp.dept_ddo_code is null AND emp.ddo_code is not null ");
    			
    			Query lQuery = neardrSession.createSQLQuery(lSBQuery.toString());
    			SevarthIdList = (int) lQuery.list().get(0);
    			
    			if(SevarthIdList>0.0 || SevarthIdList>0)
       		     SevarthIdList=(int) lQuery.list().get(0);
       	         else
       	         SevarthIdList=0;
    	...
    	private int getDDOTierIIEmpRefundGeneratedCount(String ddoOfflice, String Type) {
    		StringBuilder lSBQuery = new StringBuilder();
    		int SevarthIdList;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		Session neardrSession = sessionFactory1.openSession();
    		try {
    			lSBQuery.append(" SELECT nvl(COUNT(emp.dcps_id),0) FROM TIERTWO_BILL_DTLS bill inner JOIN TIERII_EMP_DETAILS emp on bill.BILL_ID=emp.BILLL_ID AND bill.BILL_STATUS in(6,7)   ");
    			lSBQuery.append(" inner join CMN_LOCATION_MST l on substr(emp.DDO_CODE,1,2)=substr(l.LOC_ID,1,2) AND l.DEPARTMENT_ID=100003 inner join org_ddo_mst o on emp.ddo_code=o.DDO_CODE ");
    			lSBQuery.append(" inner join CMN_LOCATION_MST l1 on l1.LOCATION_CODE=o.dept_loc_code WHERE o.DEPT_LOC_CODE='"+ddoOfflice+"'  ");
    	...
    	private Long getDDOTierIIEmpRefundGeneratedBillAmt(String ddoOffice, String Type) {
    		StringBuilder lSBQuery = new StringBuilder();
    		List SevarthIdList;
    		Long val;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		Session neardrSession = sessionFactory1.openSession();
    		try {
                lSBQuery.append(" SELECT nvl(cast(SUM(bill.total_amount)as bigint),0) FROM TIERTWO_BILL_DTLS bill inner join CMN_LOCATION_MST l on substr(bill.DDO_CODE,1,2)=substr(l.LOC_ID,1,2) ");
    			lSBQuery.append(" AND l.DEPARTMENT_ID=100003 inner join org_ddo_mst o on bill.ddo_code=o.DDO_CODE inner join CMN_LOCATION_MST l1 on l1.LOCATION_CODE=o.dept_loc_code ");
    			lSBQuery.append(" where o.dept_loc_code='"+ddoOffice+"' AND bill.BILL_STATUS in(6,7) and bill.DDO_CODE<>'1111222222' ");			
    			Query lQuery = neardrSession.createSQLQuery(lSBQuery.toString());
    			SevarthIdList = lQuery.list();
    			//val = Double.valueOf(Double.parseDouble(SevarthIdList.get(0).toString()));
                val=Long.valueOf(Long.parseLong(SevarthIdList.get(0).toString()));
                if(val>0.0 || val>0)
                val=Long.valueOf(Long.parseLong(SevarthIdList.get(0).toString()));
                else
                val=(long) 0;
    	...
    	private String getDeptYearMonth() {
    		StringBuilder lSBQuery = new StringBuilder();
    		String yearId;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		Session neardrSession = sessionFactory1.openSession();
    		...
    		String monthYearDate=year+"-%01%";
    		
    		try {
    			lSBQuery.append(" SELECT FIN_YEAR_ID FROM SGVC_FIN_YEAR_MST WHERE FROM_DATE like '"+monthYearDate+"' ");
    			
    			Query lQuery = neardrSession.createSQLQuery(lSBQuery.toString());
    			yearId = lQuery.list().get(0).toString();
    	...
    	private int getTierIIEmpRefundGeneratedCountPeriod(String treasury,String type, String startDate, String endDate) throws ParseException {
    		StringBuilder lSBQuery = new StringBuilder();
    		int SevarthIdList;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		Session neardrSession = sessionFactory1.openSession();
    		...
    		Date date1 = dt.parse(startDate);
    		SimpleDateFormat dt1 = new SimpleDateFormat("yyyy-mm-dd");
    		System.out.println(dt1.format(date1));
    		
    		Date date2 = dt.parse(endDate);
    		...
    		try {
    			...
    			lSBQuery.append(" SELECT count(emp.DCPS_ID) FROM TIERTWO_BILL_DTLS bill inner JOIN TIERII_EMP_DETAILS emp on bill.BILL_ID=emp.BILLL_ID AND bill.BILL_STATUS in(6,7) inner join CMN_LOCATION_MST l on   ");
    			lSBQuery.append(" substr(emp.DDO_CODE,1,2)=substr(l.LOC_ID,1,2) AND l.DEPARTMENT_ID=100003 inner join org_ddo_mst o on bill.ddo_code=o.DDO_CODE where substr(l.LOC_ID,1,2)='"+treasury.substring(0, 2)+"' ");
    			lSBQuery.append(" and (bill.BILL_GENERATION_DATE >='"+startDate.toString().trim()+"' and bill.BILL_GENERATION_DATE <='"+endDate.toString().trim()+"') ");
    			}else{
    			lSBQuery.append(" SELECT count(emp.DCPS_ID) FROM TIERTWO_BILL_DTLS bill inner JOIN TIERII_EMP_DETAILS emp on bill.BILL_ID=emp.BILLL_ID AND bill.BILL_STATUS in(16,17) inner join CMN_LOCATION_MST l on ");
        		lSBQuery.append(" substr(emp.DDO_CODE,1,2)=substr(l.LOC_ID,1,2) AND l.DEPARTMENT_ID=100003 inner join org_ddo_mst o on bill.ddo_code=o.DDO_CODE where substr(l.LOC_ID,1,2)='"+treasury.substring(0, 2)+"' ");
        		lSBQuery.append(" and (bill.BILL_GENERATION_DATE >='"+startDate.toString().trim()+"' and bill.BILL_GENERATION_DATE <='"+endDate.toString().trim()+"') ");
    	...
    	private int getTierIIEmpRefundGeneratedBillAmtPeriod(String treasury,String type, String startDate, String endDate) throws ParseException {
    		StringBuilder lSBQuery = new StringBuilder();
    		List SevarthIdList;
    		int val;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    	...
    	private int getDDOTierIIEmpRefundGeneratedCountPeriod(String ddoOfflice,String type, String startDate, String endDate) throws ParseException {
    		StringBuilder lSBQuery = new StringBuilder();
    		int SevarthIdList;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		Session neardrSession = sessionFactory1.openSession();
    	...
    	private Long getDDOTierIIEmpRefundGeneratedBillAmtPeriod(String ddoOfflice,String type, String startDate, String endDate) throws ParseException {
    		StringBuilder lSBQuery = new StringBuilder();
    		List SevarthIdList;
    		Long val;
    		SessionFactory sessionFactory1 = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
    		...
    		try {
                lSBQuery.append(" SELECT nvl(cast(SUM(bill.total_amount)as bigint),0) FROM TIERTWO_BILL_DTLS bill inner join CMN_LOCATION_MST l on substr(bill.DDO_CODE,1,2)=substr(l.LOC_ID,1,2) ");
    			lSBQuery.append(" AND l.DEPARTMENT_ID=100003 inner join org_ddo_mst o on bill.ddo_code=o.DDO_CODE inner join CMN_LOCATION_MST l1 on l1.LOCATION_CODE=o.dept_loc_code ");
    			lSBQuery.append(" where o.dept_loc_code='"+ddoOfflice+"' AND bill.BILL_STATUS in(6,7) and bill.DDO_CODE<>'1111222222' ");
    			lSBQuery.append(" and (bill.BILL_GENERATION_DATE >='"+startDate.toString().trim()+"' and bill.BILL_GENERATION_DATE <='"+endDate.toString().trim()+"') ");
    			Query lQuery = neardrSession.createSQLQuery(lSBQuery.toString());
    			SevarthIdList = lQuery.list();
    			//val = Double.valueOf(Double.parseDouble(SevarthIdList.get(0).toString()));
