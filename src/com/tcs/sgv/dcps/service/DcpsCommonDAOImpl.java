...
public class DcpsCommonDAOImpl extends GenericDaoHibernateImpl implements
	...
	public List getYears() {
		...
		String query = "select finYearId,finYearCode from SgvcFinYearMst where finYearCode between '2007' and '2023'";
		List<Object> lLstReturnList = null;
		StringBuilder sb = new StringBuilder();
		sb.append(query);
		Query selectQuery = ghibSession.createQuery(sb.toString());
	...
	public List getFinyear() {
		...
		String query = "select finYearId,finYearDesc from SgvcFinYearMst where finYearCode between '2007' and '2023' order by finYearCode ASC";
		List<Object> lLstReturnList = null;
		StringBuilder sb = new StringBuilder();
		sb.append(query);
		Query selectQuery = ghibSession.createQuery(sb.toString());
	...
	public List getFinyearsForDelayedType() {
		...
		String query = "select finYearId,finYearDesc from SgvcFinYearMst where finYearCode between '2005' and '2023' order by finYearCode ASC";
		List<Object> lLstReturnList = null;
		StringBuilder sb = new StringBuilder();
		sb.append(query);
		Query selectQuery = ghibSession.createQuery(sb.toString());
	...
	//added by pooja 12-10-2019
		...
		//add by uday
			public List getYears1() {
				...
				String query = "select finYearId,finYearCode from SgvcFinYearMst where finYearCode between '2012' and '2023' order by finYearCode ASC";
				List<Object> lLstReturnList = null;
				StringBuilder sb = new StringBuilder();
				sb.append(query);
				Query selectQuery = ghibSession.createQuery(sb.toString());
