...
//}
	...
	public List getDdoWiseTotalAmtSentToNSDL(Long yearId, Long monthId,
		...
		try {
			...
			sb.append(" and bh.YEAR=" + yearId + " and bh.MONTH=" + monthId+
					"  and bh.file_name like '" + strLocationCode.substring(0, 2) + "%' and bh.file_name not like '%D' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");////$t KR //+ "  /////$t  25-3-2021 $t16Dec2021 AvoidDeputationEmp 
			/*}else{
			sb.append(" and bh.YEAR=" + yearId + " and bh.MONTH=" + monthId+
	...
	public List getDdoWiseTotalAmtForDeputation(Long yearId, Long monthId,
		...
		sb.append("where trn.FIN_YEAR_ID="+ yearId+ " and trn.MONTH_ID="+ monthId+" and substr(trn.TREASURY_CODE,1,2)='"+ strLocationCode.substring(0, 2)+ "' " ////$t 8-4-2021 deputation KR one file
				+ "and (trn.IS_CHALLAN='Y' or trn.IS_ARREARS='Y')  and trn.STATUS='H'  and trn.IS_DEPUTATION='Y'  and mstemp.DDO_CODE is not null and mstemp.DEPT_DDO_CODE is null and PRAN_ACTIVE=1 and mstemp.PRAN_NO='110034415076' and mstemp.DCPS_OR_GPF='Y' ");
		...
		sb1.append("where trn.FIN_YEAR_ID="+ yearId+ " and trn.MONTH_ID="+ monthId+" and substr(trn.TREASURY_CODE,1,2)='"+ strLocationCode.substring(0, 2)+ "' " ////$t 8-4-2021 deputation KR one file
				+ "and (trn.IS_CHALLAN='Y' or trn.IS_ARREARS='Y')  and trn.STATUS='H'  and trn.IS_DEPUTATION='Y'  and mstemp.DDO_CODE is null and PRAN_ACTIVE=1 and mstemp.DEPT_DDO_CODE is null and mstemp.PRAN_NO='110034415076' and mstemp.DCPS_OR_GPF='Y' ");
		...
		sb2.append("where trn.FIN_YEAR_ID="+ yearId+ " and trn.MONTH_ID="+ monthId+" and substr(trn.TREASURY_CODE,1,2)='"+ strLocationCode.substring(0, 2)+ "' " ////$t 8-4-2021 deputation KR one file
				+ "and (trn.IS_CHALLAN='Y' or trn.IS_ARREARS='Y')  and trn.STATUS='H'  and trn.IS_DEPUTATION='Y'  and mstemp.DDO_CODE is null and PRAN_ACTIVE=1 and mstemp.DEPT_DDO_CODE is not null and mstemp.PRAN_NO='110034415076' and mstemp.DCPS_OR_GPF='Y' ");
...
////$t 2020 17-1 year 2020 n month jan added ||yrCode.equals("2020"))
		if ((yrCode.equals("2019") && (month.equals("10")|| month.equals("11") || month.equals("9")||month.equals("12")))
			...
			||(yrCode.equals("2021"))||(yrCode.equals("2022"))||(yrCode.equals("2023"))) {//$tC
			List TableData1 = null;
			List TableData2 = null;
			...
			try {
				...
				//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
				sb.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month + 
						" and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and bh.file_name not like '%D' and sd.SD_REMARK like 'Contribution for%' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");//////$t29Mar2022////$t KR //+ " and bh.file_name like '" + treasuryyno + "%'  "); /////$t 25-3-2021
				/*}else{
				sb.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month + 
				...
				sb1.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
						" and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");////$t29Mar2022 and sd.SD_REMARK like '4 Per Contribution%'
				/*}else{
				sb1.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
						" and bh.file_name like '" + treasuryyno + "%'  ");
				}*/
			...
			try {
				...
				//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
				sb.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month
						+ " and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and bh.file_name not like '%D' and sd.SD_REMARK like 'Contribution for%' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");//////$t29Mar2022////$t KR /////$t  25-3-2021
				/*}else{
				sb.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month
		...
		if ((yrCode.equals("2019") && (month.equals("10")|| month.equals("11") || month.equals("9")||month.equals("12")))
           ...
           //$t 2019 4/11
			...
			Strbld2.append("\tand bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
					" and bh.file_name like '" + treasuryyno.substring(0,2) + "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");////$t29Mar2022////$t KR //+ " and bh.file_name like '" + treasuryyno + "%'  ");
			/*}else{
			Strbld2.append("\tand bh.YEAR=" + yrCode + " and bh.MONTH=" + month+
					" and bh.file_name like '" + treasuryyno + "%'  ");	
			}*/
		...
		if ((yrCode.equals("2019") && (month.equals("10")|| month.equals("11") || month.equals("9")||month.equals("12")))
			...
			try {
				...
				Strbld.append(" and bh.YEAR=" + yrCode + " and bh.MONTH="
						...
						+ "%' and sd.SD_REMARK like 'Contribution for%' and bh.file_name not like '%D' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");//////$t29Mar2022////$t KR /////$t  25-3-2021
				/*}else{
				Strbld.append(" and bh.YEAR=" + yrCode + " and bh.MONTH="
				...
				SBQuery1.append(" and bh.YEAR=" + yrCode + " and bh.MONTH="
						+ month + " and bh.file_name like '" + treasuryyno.substring(0,2)
						+ "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");////$t29Mar2022////$t KR
				/*}else{
				SBQuery1.append(" and bh.YEAR=" + yrCode + " and bh.MONTH="
						+ month + " and bh.file_name like '" + treasuryyno
						+ "%'  ");////$t KR	
...
*/	 
	...
	public String[] getEmployeeListDdoregNsdl(String yrCode, String month,
		...
		if ((yrCode.equals("2019") && (month.equals("10")|| month.equals("11") || month.equals("9")||month.equals("12")))
			...
			//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
			Strbld1.append("and bh.YEAR='" + yrCode + "' and bh.MONTH=" + month
					+ "  and bh.file_name like '" + treasuryyno.substring(0,2) + "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");////$t29Mar2022////$t KR
			/*}else{
			Strbld1.append("and bh.YEAR='" + yrCode + "' and bh.MONTH=" + month
					+ "  and bh.file_name like '" + treasuryyno + "%'  "); 
			}*/
	...
	public List getAllSubTreasury1(String treasuryId) {
	 ...
	 public List getlstForLessEmployerContri(String yrCode, String month, String strLocationCode, String pranNo) throws Exception {
		...
		public List getRatDdoWiseTotalAmt(Long yearId, Long monthId,
				String strLocationCode, int flag) {
			...
			try {
				...
				sb.append("where head.PAYBILL_YEAR=" + yearId
						+ " and head.PAYBILL_MONTH=" + monthId
						+ "  and substr(ddo.ddo_code,1,2)='" + strLocationCode.substring(0, 2)
						+ "' and head.APPROVE_FLAG=1 and head.RAT_FLAG=1 ");/////$t KR
				/*}else{
					sb.append("where head.PAYBILL_YEAR=" + yearId
							+ " and head.PAYBILL_MONTH=" + monthId
							+ "  and substr(ddo.ddo_code,1,4)='" + strLocationCode
		...
		public List getRatDdoWiseTotalAmtSentToNSDL(Long yearId, Long monthId,
				String strLocationCode, int flag) {
			...
			try {
				...
				// cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt
				sb.append(" SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt FROM RAT_NSDL_SD_DTLS sd ");//,mst.ddo_code
				sb.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");//inner join MST_DDO_REG mst on sd.ddo_reg_no=mst.ddo_reg_no
				//if(strLocationCode.substring(0, 2).equals("12")||strLocationCode.substring(0, 2).equals("46")||strLocationCode.substring(0, 2).equals("23")||strLocationCode.substring(0, 2).equals("51")){////$t KR 5-1-2020
				sb.append(" and bh.YEAR=" + yearId + " and bh.MONTH=" + monthId+
						"  and bh.file_name like '" + strLocationCode.substring(0, 2) + "%' and bh.file_name not like '%D' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");////$t KR //+ "  /////$t  25-3-2021 $t16Dec2021 AvoidDeputationEmp
		...
		public List getEmployeeListNsdlRAT(String yrCode, String month,
				String treasuryyno, int flag) throws Exception {

			List TableData = null;
			if (yrCode.equals("2020") ||yrCode.equals("2021") || yrCode.equals("2022")|| yrCode.equals("2023")) {//$tC
				List TableData1 = null;
				List TableData2 = null;
				...
				try {
					...
					sb.append(" and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.APPROVE_FLAG=1 and head.RAT_FLAG=1 ");////$t emp.PRAN_ACTIVE=1
					sb.append(" group by  emp.EMP_NAME,emp.DCPS_ID,emp.PRAN_NO,loc.loc_name,dto.dto_reg_no,reg.ddo_reg_no ) a left outer join ");
					sb.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH ,sd.ddo_reg_no FROM RAT_NSDL_SD_DTLS sd ");
					sb.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");
					sb.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month + 
							" and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and bh.file_name not like '%D' and sd.SD_REMARK like 'Contribution for%' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");//////$t29Mar2022////$t KR //+ " and bh.file_name like '" + treasuryyno + "%'  "); /////$t 25-3-2021
					...
					sb1.append("  where head.PAYBILL_YEAR=" + yrCode
							+ " and head.PAYBILL_MONTH=" + month
							+ " and substr(ddo.ddo_code,1,2)=" + treasuryyno.substring(0,2) + " ");////$t KR 18-12-2020
					sb1.append("  and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.APPROVE_FLAG=1 and head.RAT_FLAG=1 and (cast((nvl(paybill.emplr_contri_arrears,0)) as double) <> 0  or cast((nvl(paybill.NPS_EMPLR_DIFFERENCE_ADJ,0)) as double) <> 0)  ");////$tC
					sb1.append("  group by  emp.EMP_NAME,emp.DCPS_ID,emp.PRAN_NO,loc.loc_name,dto.dto_reg_no,reg.ddo_reg_no ) a left outer join ");
					sb1.append("  (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH ,sd.ddo_reg_no FROM RAT_NSDL_SD_DTLS sd ");
					sb1.append("  inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");
					sb1.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
							" and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");
		...
		public Long getDDoRegCountRAT(String yrCode, String month, String treasuryyno,
				int flag) {
			List temp = null;
			Long regCount = null;
			if (yrCode.equals("2020") ||yrCode.equals("2021") || yrCode.equals("2022")|| yrCode.equals("2023")) {//$tC
				...
				Strbld1.append("FROM PAYBILL_HEAD_MPG head   ");
				Strbld1.append("inner join NSDL_PAYBILL_DATA paybill on paybill.PAYBILL_GRP_ID =head.PAYBILL_ID ");
				Strbld1.append("and paybill.DCPS+paybill.DCPS_PAY+paybill.DCPS_DELAY+paybill.DCPS_DA+paybill.DCPS_PAY_DIFF <=paybill.DED_ADJUST ");
				Strbld1.append("inner join ORG_DDO_MST ddo on ddo.LOCATION_CODE=paybill.LOC_ID inner join HR_EIS_EMP_MST hreis on hreis.EMP_ID=paybill.EMP_ID  ");
				Strbld1.append("inner join MST_DCPS_EMP mstemp on mstemp.ORG_EMP_MST_ID=hreis.EMP_MPG_ID ");
				Strbld1.append("inner join mst_ddo_reg reg on reg.ddo_code = ddo.ddo_code  ");
				Strbld1.append("inner join MST_DTO_REG dto on substr(dto.LOC_ID,1,2)=substr(ddo.ddo_code,1,2) ");
				...
				Strbld1.append(" where head.PAYBILL_YEAR='" + yrCode
						+ "' and head.PAYBILL_MONTH='" + month
						+ "' and substr(ddo.ddo_code,1,2)='" + treasuryyno.substring(0, 2)
						+ "' and head.APPROVE_FLAG=1 and head.RAT_FLAG=1 ");
				Strbld1.append(" and mstemp.PRAN_NO is not null and mstemp.PRAN_ACTIVE=1 and mstemp.DCPS_OR_GPF='Y' and mstemp.REG_STATUS=1 group by ddo.DDO_CODE,mstemp.PRAN_NO,reg.ddo_reg_no ,head.LOC_ID  ) a left outer join ");
				Strbld1.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM RAT_NSDL_SD_DTLS sd  ");
				Strbld1.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");
				Strbld1.append("\tand bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
						" and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and bh.file_name not like '%D' and sd.SD_REMARK like 'Contribution for%' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");
				Strbld1.append(" group by sd.SD_PRAN_NO,bh.YEAR,bh.MONTH,sd.ddo_reg_no ) b on b.SD_PRAN_NO=a.PRAN_NO and b.ddo_reg_no=a.ddo_reg_no where a.employye-cast(nvl(b.sd_amnt,0) as double) >0 and a.DED_ADJUST-cast(nvl(b.sd_emplr_amnt,0) as double) >0 ");
				...
				Strbld2.append(" where head.PAYBILL_YEAR='" + yrCode
						...
						+ "' and head.APPROVE_FLAG=1 and head.RAT_FLAG=1 ");
				Strbld2.append(" and mstemp.PRAN_NO is not null and mstemp.PRAN_ACTIVE=1 and mstemp.DCPS_OR_GPF='Y' and mstemp.REG_STATUS=1 and (cast((nvl(paybill.emplr_contri_arrears,0)) as double) <> 0  or cast((nvl(paybill.NPS_EMPLR_DIFFERENCE_ADJ,0)) as double) <> 0) group by ddo.DDO_CODE,mstemp.PRAN_NO,reg.ddo_reg_no ,head.LOC_ID  ) a left outer join ");////$tC
				Strbld2.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM RAT_NSDL_SD_DTLS sd  ");
				Strbld2.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");
				Strbld2.append("\t and bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
						" and bh.file_name like '" + treasuryyno.substring(0,2) + "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");
		...
		public List getEmployeeContriTotalListRAT(String yrCode, String month,
				String treasuryyno, int flag) {
			...
			StringBuilder Strbld = new StringBuilder();
			Strbld.append("select cast(sum(a.emp_amt-nvl(b.sd_amnt,0)) as VARCHAR(20)) ||'#'|| cast(sum(a.DED_ADJUST-nvl(b.sd_emplr_amnt,0)) as VARCHAR(20)) from ");
			Strbld.append("(SELECT sum(paybill.DCPS)+sum(paybill.DCPS_PAY)+sum(paybill.DCPS_DELAY)+sum(paybill.DCPS_DA)+sum(paybill.DCPS_PAY_DIFF) as emp_amt,    ");
			Strbld.append("sum(paybill.DED_ADJUST) as DED_ADJUST ,emp.pran_no,reg.ddo_reg_no  FROM mst_dcps_emp emp inner join HR_EIS_EMP_MST eis on eis.EMP_MPG_ID=emp.ORG_EMP_MST_ID ");
			Strbld.append("inner join NSDL_PAYBILL_DATA paybill on paybill.EMP_ID=eis.EMP_ID ");
			Strbld.append(" inner join PAYBILL_HEAD_MPG head on head.PAYBILL_ID=paybill.PAYBILL_GRP_ID ");
			Strbld.append(" and paybill.DCPS+paybill.DCPS_PAY+paybill.DCPS_DELAY+paybill.DCPS_DA+paybill.DCPS_PAY_DIFF <=paybill.DED_ADJUST  ");
			Strbld.append(" inner join ORG_DDO_MST ddo on ddo.LOCATION_CODE=paybill.LOC_ID ");
			Strbld.append("inner join mst_ddo_reg reg on reg.ddo_code = ddo.ddo_code  ");
			Strbld.append(" inner join MST_DTO_REG dto on substr(dto.LOC_ID,1,2)=substr(ddo.ddo_code,1,2)  ");
			Strbld.append(" inner join CMN_LOCATION_MST loc on loc.LOC_ID=substr(ddo.DDO_CODE,1,4)  ");
			Strbld.append(" where head.PAYBILL_YEAR=" + yrCode
					+ " and head.PAYBILL_MONTH=" + month
					+ "  and substr(ddo.ddo_code,1,2)='" + treasuryyno.substring(0,2) + "' ");
			Strbld.append(" and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.APPROVE_FLAG=1 and head.RAT_FLAG=1 group by emp.pran_no,reg.ddo_reg_no ) a left outer join ");
			Strbld.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt ,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM RAT_NSDL_SD_DTLS sd ");
			Strbld.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");
			Strbld.append(" and bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
					" and bh.file_name like '" + treasuryyno.substring(0,2) + "%' and bh.file_name not like '%D' and sd.SD_REMARK like 'Contribution for%' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");
			...
			StringBuilder Strbld1 = new StringBuilder();
			 ...
			 Strbld1.append(" and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.RAT_FLAG=1 and (cast((nvl(paybill.emplr_contri_arrears,0)) as double) <> 0  or cast((nvl(paybill.NPS_EMPLR_DIFFERENCE_ADJ,0)) as double) <> 0) and head.APPROVE_FLAG=1 group by emp.pran_no,reg.ddo_reg_no ) a left outer join ");////$tC
			 Strbld1.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt ,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM RAT_NSDL_SD_DTLS sd ");
			 Strbld1.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");
			 Strbld1.append(" and bh.YEAR=" +
			 yrCode +
		...
		public String[] getEmployeeCountDdoregNsdlRAT(String yrCode, String month,
				String treasuryyno, int flag) {
			String[] empCountLst = new String[1];
			...
			if (yrCode.equals("2020") ||yrCode.equals("2021") || yrCode.equals("2022")|| yrCode.equals("2023")) {//$tC
				...
				try {
					...
					Strbld.append(" and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.APPROVE_FLAG=1 and head.RAT_FLAG=1 ");
					Strbld.append(" group by  emp.EMP_NAME,emp.DCPS_ID,emp.PRAN_NO,loc.loc_name,dto.dto_reg_no,reg.ddo_reg_no ) a left outer join ");
					Strbld.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM RAT_NSDL_SD_DTLS sd ");
					Strbld.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");
					Strbld.append(" and bh.YEAR=" + yrCode + " and bh.MONTH="
					...
					SBQuery1.append(" and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.APPROVE_FLAG=1 and head.RAT_FLAG=1 and (cast((nvl(paybill.emplr_contri_arrears,0)) as double) <> 0  or cast((nvl(paybill.NPS_EMPLR_DIFFERENCE_ADJ,0)) as double) <> 0) ");////$tC
					SBQuery1.append(" group by  emp.EMP_NAME,emp.DCPS_ID,emp.PRAN_NO,loc.loc_name,dto.dto_reg_no,reg.ddo_reg_no ) a left outer join ");
					SBQuery1.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM RAT_NSDL_SD_DTLS sd ");
					SBQuery1.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");
					SBQuery1.append(" and bh.YEAR=" + yrCode + " and bh.MONTH="
							+ month + " and bh.file_name like '" + treasuryyno.substring(0,2)
							+ "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");////$t29Mar2022////$t KR
		...
		public String[] getEmployeeListDdoregNsdlRAT(String yrCode, String month,
				String treasuryyno, int flag) throws HibernateException,
				SQLException {
			List empLst = null;
			String[] empDdoLst = new String[1];
			...
			if (yrCode.equals("2020") ||yrCode.equals("2021") || yrCode.equals("2022")|| yrCode.equals("2023")) {//$tC
				...
				Strbld1.append("where head.PAYBILL_YEAR='" + yrCode
						+ "' and head.PAYBILL_MONTH='" + month
						+ "'  and substr(ddo.ddo_code,1,2)='" + treasuryyno.substring(0,2) + "' ");
				Strbld1.append(" and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.APPROVE_FLAG=1 and head.RAT_FLAG=1 and (cast((nvl(paybill.emplr_contri_arrears,0)) as double) <> 0  or cast((nvl(paybill.NPS_EMPLR_DIFFERENCE_ADJ,0)) as double) <> 0) group by emp.pran_no,reg.ddo_reg_no  ) a left outer join ");////$tC
				Strbld1.append("(SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM RAT_NSDL_SD_DTLS sd ");
				Strbld1.append("inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME and bh.RAT_STATUS <>-1 ");
				Strbld1.append("and bh.YEAR='" + yrCode + "' and bh.MONTH=" + month
						+ "  and bh.file_name like '" + treasuryyno.substring(0,2) + "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");
		...
		public void insertDHDetailsRAT(int i, String string, String string2, int j,
				String ddoRegNo, Long empCount, String totalEmplyDHContri,
				String totalEmplyerDHContri, String batchId) {
			Session session = getSession();
			StringBuffer str = new StringBuffer();
			str.append("insert into RAT_NSDL_DH_dtls values ('" + i + "','" + string
					+ "','" + string2 + "','" + j + "','" + ddoRegNo + "','"
					+ empCount + "',");
			str.append("'" + totalEmplyDHContri + "','" + totalEmplyerDHContri
					+ "','" + batchId + "',9,0,null)");
		...
		public List getlstForLessEmployerContriRAT(String yrCode, String month, String strLocationCode, String pranNo) throws Exception {
		      List contrList = null;
		      Query lQuery = null;
		      StringBuilder sb = null;
		...
		public void insertSDDetailsRAT(int i, String string, String string2, int j,
				int empCount, String pranno, String govEmpContri,
				String subempContri, String string3, String string4,
				String batchId, String string5, String ddoRegNo)
				throws HibernateException, SQLException {
			Session session = getSession();
			StringBuffer str = new StringBuffer();
			str.append("insert into RAT_NSDL_SD_dtls values ('" + i + "','" + string
					+ "','" + string2 + "','" + j + "','" + empCount + "','"
					+ pranno + "',");
			str.append("'" + govEmpContri + "','" + subempContri + "','" + string3
					+ "','" + string4 + "','" + batchId + "','" + string5 + "','"
		...
		public void insertBatchHeaderRAT(String bhHeader1, String bhHeader,
				String bhHeader2, String string4, String string5,
				String currentdate, String string6, long ddoCount, int count,
				String govContri, String subContri, String total, String fileName,
				String yrCode, String month) {
			Session session = getSession();
			StringBuffer str = new StringBuffer();
			str.append("insert into RAT_NSDL_BH_dtls values ('" + bhHeader1 + "','"
					+ bhHeader + "','" + bhHeader2 + "','" + string4 + "','"
					+ string5 + "','" + currentdate + "',");
			str.append("'" + string6 + "','" + ddoCount + "','" + count + "','"
					+ subContri + "','" + govContri + "','" + total + "','"
					+ fileName + "','" + yrCode + "','" + month + "','" + 9
					+ "',null,9,null,null,null,null,null,'0',null,null,null,null,sysdate,'0',null)");
			Query updateQuery = session.createSQLQuery(str.toString());
			this.logger.info("Query to insert in batch heaqder**********"
					+ str.toString());
		...
		public String getbatchIdCountRAT(String batchIdPrefix) {
			String lLstReturnList = "";
			StringBuilder sb = new StringBuilder();
			this.logger.info("getbatchIdCount1");

			sb.append(" select count(1)+1 from RAT_NSDL_BH_dtls where FILE_NAME like '"
					+ batchIdPrefix + "%'");
			Query selectQuery = this.ghibSession.createSQLQuery(sb.toString());
			lLstReturnList = selectQuery.uniqueResult().toString();
			this.logger.info("getbatchIdCount1" + lLstReturnList);
		...
		public List getAllDataRAT(String yrCode, String month, String strLocationCode)
				throws Exception {
			List contrList = null;
			Query lQuery = null;
			StringBuilder lSBQuery = null;
			try {
				lSBQuery = new StringBuilder();
				lSBQuery.append(" SELECT distinct bh.FILE_NAME,bh.BH_EMP_AMOUNT,bh.BH_EMPLR_AMOUNT,NVL(cast(nsdl.BILL_ID as varchar(20)),'NA'),NVL(cast(nsdl.AUTH_NUMBER as varchar(20)),'NA'),decode(nsdl.BILL_STATUS,0,'PayBill Generated',1,'Paybill Approved',2,'Bill Rejected by Beams',3,'Bill Authorized by BEAMS','PayBill Not Generated'),nsdl.BILL_STATUS,bh.RAT_STATUS,decode(NSDL_RESPONSE_HTML,null,1,2),nsdl.VOUCHER_NO,to_char(nsdl.VOUCHER_DATE,'dd/mm/yyyy') FROM RAT_NSDL_BH_DTLS bh   ");

				lSBQuery.append("  left outer join ifms.RAT_NSDL_BILL_DTLS nsdl on nsdl.FILE_NAME=bh.FILE_NAME  and nsdl.BILL_STATUS <> -1  where bh.MONTH='"
						+ month
						+ "' and bh.YEAR= '"
						+ yrCode
						+ "' "
						+ " and bh.file_name like '"+ strLocationCode+ "%' and bh.file_name not like '"+ strLocationCode+ "%D' and bh.RAT_STATUS <> -1 order by bh.file_name ");
		...
		public void deleteFileReport(String fileNumber) throws HibernateException,
		SQLException {
	StringBuilder sb = new StringBuilder();
	sb.append("  update RAT_NSDL_BH_DTLS set RAT_STATUS=-1 where FILE_NAME='"
			+ fileNumber + "' and RAT_STATUS='0' ");
	Query updateQuery = this.ghibSession.createSQLQuery(sb.toString());
	...
	StringBuilder sb1 = new StringBuilder();
	sb1.append("  update RAT_NSDL_DH_DTLS set RAT_STATUS=-1 where FILE_NAME='"
			+ fileNumber + "' and RAT_STATUS='0' ");
	Query updateQuery1 = this.ghibSession.createSQLQuery(sb1.toString());
	...
	StringBuilder sb2 = new StringBuilder();
	sb2.append("  update RAT_NSDL_SD_DTLS set RAT_STATUS=-1 where FILE_NAME='"
			+ fileNumber + "' and RAT_STATUS='0' ");
	Query updateQuery2 = this.ghibSession.createSQLQuery(sb2.toString());
	...
	updateQuery2.executeUpdate();	
		...
		public void updateBillStatusRAT(String billId, String fileNameTODelete)
				throws HibernateException, SQLException {
			Session hibSession = getSession();
			StringBuffer str = new StringBuffer();

			str.append("update RAT_NSDL_BILL_DTLS set BILL_STATUS = -1,FILE_NAME = '"
					+ fileNameTODelete + "' where BILL_ID = " + billId
					+ " and BILL_STATUS = 2 ");
		...
		public String getBillStatusRAT(String fileNumber) {
			List temp = null;
			String billStatus = "";
			StringBuilder Strbld = new StringBuilder();

			Strbld.append(" SELECT count(1) FROM RAT_NSDL_BILL_dtls where  FILE_NAME='"
					+ fileNumber + "' and bill_status<>-1 ");
		...
		public void createNSDLBillGenrationRAT(Long nsdl_paybill_pk, String year,
				String month, double employeeContribution,
				double employerContribution, double totalContribution,
				String fileNumber) throws HibernateException, SQLException {
			StringBuilder sb = new StringBuilder();
			sb.append("  INSERT INTO RAT_NSDL_BILL_dtls  VALUES (" + nsdl_paybill_pk
					+ "," + year + "," + month + "," + employeeContribution + ","
					+ employerContribution + "," + totalContribution
					+ ",null,null,'0',sysdate,'" + fileNumber + "',null,'0',null) ");
			Query updateQuery = this.ghibSession.createSQLQuery(sb.toString());
			this.logger.info("Query to createNSDLBillGenration**********"+ sb.toString());
			updateQuery.executeUpdate();
			
			sb = new StringBuilder();
			sb.append("update RAT_nsdl_bh_dtls set RAT_status ='1' where file_name = '"+ fileNumber + "' and RAT_status ='0' ");
			updateQuery = ghibSession.createSQLQuery(sb.toString());
			updateQuery.executeUpdate();
			
			sb = new StringBuilder();
			sb.append("update RAT_nsdl_dh_dtls set RAT_status ='1' where file_name = '"+ fileNumber + "' and RAT_status ='0' ");
			updateQuery = ghibSession.createSQLQuery(sb.toString());
			updateQuery.executeUpdate();
			
			sb = new StringBuilder();
			sb.append("update RAT_nsdl_sd_dtls set RAT_status ='1' where file_name = '"+ fileNumber + "' and RAT_status ='0' ");
			updateQuery = ghibSession.createSQLQuery(sb.toString());
			updateQuery.executeUpdate();
		}
		
		public List getBillNoDateRAT(String fileNumber) {
			List billDetails = null;
			Long billNo = Long.valueOf(0L);
			StringBuilder Strbld = new StringBuilder();

			Strbld.append(" SELECT BILL_ID,to_char(BILL_GENERATION_DATE,'dd/mm/yyyy'),month(BILL_GENERATION_DATE),BILL_MONTH FROM ifms.RAT_NSDL_BILL_dtls where  FILE_NAME='"+ fileNumber + "' ");
		...
		public int getMonthIdRAT(String fileNumber) {
			List temp = null;
			int transactionId = 0;
			StringBuilder Strbld = new StringBuilder();

			Strbld.append(" SELECT month FROM RAT_NSDL_BH_DTLS where FILE_NAME='"
					+ fileNumber + "' ");
		...
		public String getFYearRAT(String fileNumber) {
			String finyear = null;
			List temp;
			StringBuilder sb = new StringBuilder();
			try {
				...
				sb.append(" CASE when substr(bh_date,3,2) > 3 then  substr(bh_date,5,4)||'-'||cast (cast( (substr(bh_date,7,2)) as INTEGER) +1 as char(4) )  ");
				sb.append(" else cast (cast( (substr(bh_date,7,2)) as INTEGER) -1 as char(4))||'-'||substr(bh_date,5,4) ");
				sb.append(" end  from RAT_NSDL_BH_DTLS WHERE FILE_NAME='" + fileNumber
						+ "' ");
				Query selectQuery = this.ghibSession.createSQLQuery(sb.toString());
				this.logger.info("  getFYear ---------" + selectQuery.toString());
				temp = selectQuery.list();
		...
		public void updateNsdlBillDetailsRAT(String authNo, long paybillId, String flag) {
			try {
				Session hibSession = getSession();
				StringBuffer str = new StringBuffer();
				Query query1;
				if (flag.equals("Y")) {
					str.append("update RAT_NSDL_BILL_DTLS set AUTH_NUMBER = '" + authNo
							+ "',BILL_STATUS = 3 where BILL_ID = " + paybillId
							+ " ");
					
					this.gLogger.error("str" + str);
					query1 = hibSession.createSQLQuery(str.toString());
					int size=query1.executeUpdate();
				} else {
					str.append("update NSDL_BILL_DTLS set BILL_STATUS = 2 where BILL_ID = "
							+ paybillId + " ");
					this.gLogger.error("str" + str);
		...
		public List getAllDataRATF(String yrCode, String month, String strLocationCode)
				throws Exception {
			List contrList = null;
			Query lQuery = null;
			StringBuilder lSBQuery = null;
			try {
				lSBQuery = new StringBuilder();
				lSBQuery.append(" SELECT distinct bh.FILE_NAME,bh.BH_EMP_AMOUNT,bh.BH_EMPLR_AMOUNT,NVL(cast(nsdl.BILL_ID as varchar(20)),'NA'),NVL(cast(nsdl.AUTH_NUMBER as varchar(20)),'NA') , decode(nsdl.BILL_STATUS,0,'PayBill Generated',1,'Paybill Approved',2,'Bill Rejected by Beams',3,'Bill Authorized by BEAMS','Paybill Not Generated')  , NVL(bh.TRANSACTION_ID,'-') ,   decode(bh.file_status,0,'File not Validated',1,'File is validated',2,'File is rejected',3,'File has been modified by User',5,'File has been sent to NSDL',11,'Transaction Id Updated',8,'Transaction Id Lapsed') ,nsdl.BILL_STATUS,bh.file_status,decode(NSDL_RESPONSE_HTML,null,1,2) ");
				lSBQuery.append(" ,nsdl.voucher_no,to_char(nsdl.VOUCHER_DATE,'dd/mm/yyyy') FROM RAT_NSDL_BH_DTLS bh ");
				lSBQuery.append("  left outer join ifms.RATF_NSDL_BILL_DTLS nsdl on nsdl.FILE_NAME=bh.FILE_NAME  and nsdl.BILL_STATUS <> -1  where bh.MONTH='"
						+ month
						+ "' and bh.YEAR= '"
						+ yrCode
						+ "' "
						+ "and bh.file_name like '"
						+ strLocationCode
						+ "%' and bh.file_name not like '"+ strLocationCode+ "%D' and bh.STATUS not in(-1,9) ");
		...
		public String getBatchDataRATF(String fileNumber) {
			String lLstReturnList = "";
			StringBuilder sb = new StringBuilder();

			sb.append(" select SR_NO||'^'||HEADER_NAME||'^'||BH_NO||'^'||BH_COL2||'^'||BH_FIX_NO||'^'||BH_DATE||'^'||BH_BATCH_FIX_ID||'^^'||BH_DDO_COUNT||'^'||BH_PRAN_COUNT||'^'||BH_EMPLR_AMOUNT||'^'||BH_EMP_AMOUNT||'^^'||BH_TOTAL_AMT||'^' from RAT_NSDL_BH_dtls ");
			sb.append(" where FILE_NAME='" + fileNumber + "' ");
		...
		public List getDHDataRATF(String fileNumber) {
			List lLstReturnList = null;
			StringBuilder sb = new StringBuilder();
			sb.append(" SELECT SR_NO||'^'||HEADER_NAME||'^'||DH_NO||'^'||DH_COL2||'^'||DH_DDO_REG_NO||'^'||BH_SD_COUNT||'^'||DH_EMPLR_AMOUNT||'^'||DH_EMP_AMOUNT||'^^',DH_DDO_REG_NO FROM RAT_NSDL_DH_dtls ");
			sb.append(" where FILE_NAME='" + fileNumber
					+ "' and DH_EMP_AMOUNT > 0 order by SR_NO asc");
		...
		public List getDHData1RATF(String fileNumber) {
			List lLstReturnList = null;
			StringBuilder sb = new StringBuilder();
			sb.append(" SELECT SR_NO||'^'||HEADER_NAME||'^'||DH_NO||'^'||DH_COL2||'^'||DH_DDO_REG_NO||'^'||BH_SD_COUNT||'^'||DH_EMPLR_AMOUNT||'^'||DH_EMP_AMOUNT||'^^',DH_DDO_REG_NO FROM RAT_NSDL_DH_dtls ");
			sb.append(" where FILE_NAME='" + fileNumber
		...
		public List getSDDtlsRATF(String fileNumber, String ddoRegNo) {
			List lLstReturnList = null;
			StringBuilder sb = new StringBuilder();
			sb.append(" SELECT SR_NO||'^'||HEADER_NAME||'^'||SD_NO||'^'||SD_NO_2||'^'||SD_NO_3||'^'||SD_PRAN_NO||'^'||SD_EMPLR_AMOUNT||'^'||SD_EMP_AMOUNT||'^'||'^'||SD_TOTAL_AMT||'^'||SD_STATUS||'^'||SD_REMARK||'^' FROM RAT_NSDL_SD_DTLS  ");
			sb.append(" where   FILE_NAME='" + fileNumber + "'and DDO_REG_NO='"
					+ ddoRegNo + "' and SD_EMP_AMOUNT > 0 order by SR_NO asc ");
		...
		public List getSDDtls1RATF(String fileNumber, String ddoRegNo) {
			List lLstReturnList = null;
			StringBuilder sb = new StringBuilder();
			sb.append(" SELECT SR_NO||'^'||HEADER_NAME||'^'||SD_NO||'^'||SD_NO_2||'^'||SD_NO_3||'^'||SD_PRAN_NO||'^'||SD_EMPLR_AMOUNT||'^'||SD_EMP_AMOUNT||'^'||'^'||SD_TOTAL_AMT||'^'||SD_STATUS||'^'||SD_REMARK||'^' FROM RAT_NSDL_SD_DTLS  ");
			sb.append(" where   FILE_NAME='" + fileNumber + "'and DDO_REG_NO='"
		...
		public void updateFileStatusRATF(int fileStatus, String fileno, String errorData)
				throws HibernateException, SQLException {
			StringBuilder sb = new StringBuilder();
			errorData = errorData.replace("'", "");
			sb.append("  update RAT_NSDL_BH_DTLS set file_status='" + fileStatus
					+ "'  ");
			if ((errorData != null) && (!errorData.equals(""))) {
				sb.append(" , error_data='" + errorData + "' ");
			}
		...
		public void deleteNsdlFileRATF(String fileNumber) throws HibernateException,
		SQLException {
	StringBuilder sb = new StringBuilder();
	sb.append("  update RAT_NSDL_BH_DTLS set status=-1 where FILE_NAME='"
			+ fileNumber + "' and STATUS='0' and FILE_STATUS='0' ");
	Query updateQuery = this.ghibSession.createSQLQuery(sb.toString());
	...
	StringBuilder sb1 = new StringBuilder();
	sb1.append("  update RAT_NSDL_DH_DTLS set DH_status=-1 where FILE_NAME='"
			+ fileNumber + "' and DH_STATUS='0' ");
	Query updateQuery1 = this.ghibSession.createSQLQuery(sb1.toString());
	...
	StringBuilder sb2 = new StringBuilder();
	sb2.append("  update RAT_NSDL_SD_DTLS set status=-1 where FILE_NAME='"
			+ fileNumber + "' and STATUS='0' ");
	Query updateQuery2 = this.ghibSession.createSQLQuery(sb2.toString());

	this.logger.info("Query to delete in deleteNsdlFileRATF heaqder**********"
			+ sb2.toString());

	updateQuery2.executeUpdate();
  }
		
		public void updateBillStatusRATF(String billId, String fileNameTODelete)
				throws HibernateException, SQLException {
			Session hibSession = getSession();
			StringBuffer str = new StringBuffer();

			str.append("update RATF_NSDL_BILL_DTLS set BILL_STATUS = -1,FILE_NAME = '"
					+ fileNameTODelete + "' where BILL_ID = " + billId
					+ " and BILL_STATUS = 2 ");
		...
		public String getBillStatusRATF(String fileNumber) {
			List temp = null;
			String billStatus = "";
			StringBuilder Strbld = new StringBuilder();

			Strbld.append(" SELECT count(1) FROM RATF_NSDL_BILL_dtls where  FILE_NAME='"
					+ fileNumber + "' and bill_status<>-1 ");
		...
		public void createNSDLBillGenrationRATF(Long nsdl_paybill_pk, String year,
				String month, double employeeContribution,
				double employerContribution, double totalContribution,
				String fileNumber) throws HibernateException, SQLException {
			int flag;
			StringBuilder sb = new StringBuilder();
			sb.append(" SELECT count(1) FROM RAT_nsdl_bh_dtls where file_name = '"+ fileNumber + "' and transaction_id is not null ");
			Query updateQuery = ghibSession.createSQLQuery(sb.toString());
			flag = (int) updateQuery.list().get(0);
			
			if(flag>0){
			sb = new StringBuilder();
			sb.append("  INSERT INTO RATF_NSDL_BILL_dtls  VALUES (" + nsdl_paybill_pk
					+ "," + year + "," + month + "," + employeeContribution + ","
					+ employerContribution + "," + totalContribution
					+ ",null,null,'0',sysdate,'" + fileNumber + "',null,'0',null) ");
			updateQuery = this.ghibSession.createSQLQuery(sb.toString());
			this.logger.info("Query to createNSDLBillGenration**********"+ sb.toString());
			updateQuery.executeUpdate();
			}
		}
		
		public void updateVoucherEntryRAT(String BillNo, String authNO, String voucherNo, String vouchedate,String fileNumber)
			...
			try {
				...
				sb.append("  update ifms.RAT_NSDL_BILL_DTLS set VOUCHER_NO="+ voucherNo + ",VOUCHER_DATE='" + timestampvouchedate+ "' where file_name='" + fileNumber + "' and BILL_ID='" + BillNo + "' and AUTH_NUMBER='" + authNO + "' and BILL_STATUS=3 ");
				Query updateQuery = this.ghibSession.createSQLQuery(sb.toString());
				this.logger.info("Query to updateVoucherEntry**********"+ sb.toString());
				int size=updateQuery.executeUpdate();
				if(size>0){	
					sb = new StringBuilder();
					sb.append("update RAT_nsdl_bh_dtls set file_status ='0',status='0' where file_name ='"+ fileNumber +"' ");
					updateQuery = this.ghibSession.createSQLQuery(sb.toString());
					updateQuery.executeUpdate();
					
					sb = new StringBuilder();
					sb.append("update RAT_nsdl_dh_dtls set dh_status='0' where file_name ='"+ fileNumber + "' ");
					updateQuery = this.ghibSession.createSQLQuery(sb.toString());
					updateQuery.executeUpdate();
					
					sb = new StringBuilder();
					sb.append("update RAT_nsdl_sd_dtls set status='0' where file_name ='"+ fileNumber + "' ");
					updateQuery = this.ghibSession.createSQLQuery(sb.toString());
					updateQuery.executeUpdate();
					}
			} catch (Exception e) {
		...
		public List getBillIdRAT(String fileNumber, long intMonth, long intYear) {
			List billDetails = null;
			Long billNo = Long.valueOf(0L);
			StringBuilder Strbld = new StringBuilder();

			Strbld.append(" SELECT BILL_ID,BILL_GENERATION_DATE FROM RAT_NSDL_BILL_dtls where FILE_NAME  = '"+ fileNumber+ "' and BILL_YEAR = "+ intYear+ " and BILL_MONTH = " + intMonth + "  and BILL_STATUS = 0 ");
			SQLQuery lQuery = this.ghibSession.createSQLQuery(Strbld.toString());
		...
		public int getCountRAT(long intMonth, long intYear, long paybillId) {
			Session hibSession = getSession();
			int count = 0;
			StringBuffer sb = new StringBuffer();
			sb.append(" SELECT count(sd.SR_NO) FROM RAT_NSDL_SD_DTLS sd inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME = sd.FILE_NAME ");
			sb.append(" inner join RAT_NSDL_BILL_DTLS bill on bill.FILE_NAME = bh.FILE_NAME  ");
			sb.append(" where  bh.RAT_STATUS = 1 and bill.BILL_STATUS = 0 and bill.BILL_MONTH = "
					+ intMonth
					+ " and bill.BILL_YEAR = "
					+ intYear
					+ " and bill.BILL_ID = " + paybillId + " ");
		...
		public long getGrossAmountRAT(long intMonth, long intYear, long paybillId) {
			List sev = null;
			Long grossAmount = Long.valueOf(0L);
			Double grossValue = Double.valueOf(0.0D);
			try {
				StringBuilder lSBQuery = new StringBuilder();
				lSBQuery.append(" SELECT bh.BH_TOTAL_AMT FROM RAT_NSDL_BH_DTLS bh inner join RAT_NSDL_BILL_DTLS bill on bill.FILE_NAME = bh.FILE_NAME ");
				lSBQuery.append("where bh.RAT_STATUS in (1) and bill.BILL_STATUS = 0 and bill.BILL_MONTH = "
						+ intMonth
						+ " and bill.BILL_YEAR = "
						+ intYear
						+ " and bill.BILL_ID = " + paybillId + " ");
		...
		public List getBillNoDateRATF(String fileNumber) {
			List billDetails = null;
			Long billNo = Long.valueOf(0L);
			StringBuilder Strbld = new StringBuilder();

			Strbld.append(" SELECT BILL_ID,to_char(BILL_GENERATION_DATE,'dd/mm/yyyy'),month(BILL_GENERATION_DATE),BILL_MONTH FROM ifms.RATF_NSDL_BILL_dtls where  FILE_NAME='"+ fileNumber + "' ");
		...
		public void updateVoucherEntryRATF(String BillNo, String authNO, String voucherNo, String vouchedate,String fileNumber)
				throws HibernateException, SQLException, ParseException {
			...
			try {
				...
				sb.append("  update ifms.RATF_NSDL_BILL_DTLS set VOUCHER_NO="+ voucherNo + ",VOUCHER_DATE='" + timestampvouchedate+ "' where file_name='" + fileNumber + "' and BILL_ID='" + BillNo + "' and AUTH_NUMBER='" + authNO + "' and BILL_STATUS=3 ");
				Query updateQuery = this.ghibSession.createSQLQuery(sb.toString());
				this.logger.info("Query to updateVoucherEntry**********"+ sb.toString());
				updateQuery.executeUpdate();
		...
		public List getDdoWiseTotalAmtForDeputationRAT(Long yearId, Long monthId,
				String strLocationCode, String yearCode, String treasuryDDOCode) {// 2019,6,1111,2019,1111222222
			List lLstReturnList = null;
			List lLstReturnList1 = null;
			List lLstReturnList2 = null;
			...
			sb.append("group  by  ddo.DDO_CODE,mstemp.pran_no) abc ");
			sb.append(" left outer join ( SELECT sd.SD_PRAN_NO, cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt, cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt, bh.YEAR, bh.MONTH FROM RAT_NSDL_SD_DTLS sd ");
			sb.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME ");
			sb.append(" and bh.RAT_STATUS <>-1 ");
			sb.append(" and bh.YEAR=" + yearCode +" and bh.MONTH=" + monthId +" and bh.file_name like '" + strLocationCode.substring(0, 2) + "%D'" ////$t 8-4-2021 deputation KR one file
					+ " group by sd.SD_PRAN_NO,bh.YEAR,bh.MONTH ) ");
			sb.append(" a on a.SD_PRAN_NO=abc.pran_no   where  cast(abc.c-nvl(a.sd_amnt,0) as double) >=0 and cast(abc.d-nvl(a.sd_emplr_amnt,0) as double) >0 ");
			...
			sb1.append("group  by  ddo.DDO_CODE,mstemp.pran_no) abc ");
			sb1.append(" left outer join ( SELECT sd.SD_PRAN_NO, cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt, cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt, bh.YEAR, bh.MONTH FROM RAT_NSDL_SD_DTLS sd ");
			sb1.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME ");
			sb1.append(" and bh.RAT_STATUS <>-1 ");
			sb1.append(" and bh.YEAR=" + yearCode +" and bh.MONTH=" + monthId +" and bh.file_name like '" + strLocationCode.substring(0, 2) + "%D'" ////$t 8-4-2021 deputation KR one file
					+ " group by sd.SD_PRAN_NO,bh.YEAR,bh.MONTH ) ");
			sb1.append(" a on a.SD_PRAN_NO=abc.pran_no   where  cast(abc.c-nvl(a.sd_amnt,0) as double) >=0 and cast(abc.d-nvl(a.sd_emplr_amnt,0) as double) >0 ");
			...
			sb2.append("group  by  ddo.DDO_CODE,mstemp.pran_no) abc ");
			sb2.append(" left outer join ( SELECT sd.SD_PRAN_NO, cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt, cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt, bh.YEAR, bh.MONTH FROM RAT_NSDL_SD_DTLS sd ");
			sb2.append(" inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME ");
			sb2.append(" and bh.RAT_STATUS <>-1 ");
			sb2.append(" and bh.YEAR=" + yearCode +" and bh.MONTH=" + monthId +" and bh.file_name like '" + strLocationCode.substring(0, 2) + "%D'" ////$t 8-4-2021 deputation KR one file
					+ " group by sd.SD_PRAN_NO,bh.YEAR,bh.MONTH ) ");
			sb2.append(" a on a.SD_PRAN_NO=abc.pran_no   where  cast(abc.c-nvl(a.sd_amnt,0) as double) >=0 and cast(abc.d-nvl(a.sd_emplr_amnt,0) as double) >0 ");
		...
		public List getEmployeeListNsdlForDeputationRAT(String yrCode, String month,
				String treasuryyno, String year, String treasuryDDOCode,
				String trDdoReg) {// $t back up
			List empLst = null;
			List lLstReturnList1 = null;
			...
			try {
				...
				sb.append(" and mstemp.DDO_CODE is not null and mstemp.DEPT_DDO_CODE is null and mstemp.DCPS_OR_GPF='Y' ");
				sb.append(" group by mstemp.EMP_NAME, mstemp.DCPS_ID, mstemp.PRAN_NO, reg.ddo_reg_no) abc ");
				sb.append(" left outer join (    SELECT    sd.SD_PRAN_NO,    cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt ,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt,    bh.YEAR,    bh.MONTH    FROM RAT_NSDL_SD_DTLS sd    inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME ");
				sb.append(" and bh.RAT_STATUS <>-1    and bh.YEAR=" + year+ " and bh.MONTH=" + month + " and ");
				sb.append(" bh.file_name like '"+ treasuryyno.substring(0, 2)+ "%D' group by sd.SD_PRAN_NO,bh.YEAR,bh.MONTH ) a on a.sd_pran_no=abc.pran_no ");////$t 8-4-2021 deputation KR one file
				sb.append(" where  cast(abc.c-nvl(a.sd_amnt,0) as double) >=0 and cast(abc.d-nvl(a.sd_emplr_amnt,0) as double) >0 order by abc.DDO_REG_NO ");
		...
		public Long getDDoRegCountDeputationRAT(String yrCode, String month,
				String treasuryyno, String year, String treasuryDDOCode) {
			List empLst = null;
			List lLstReturnList1 = null;
			List lLstReturnList2 = null;
		...
		public List getEmployeeContriTotalListForDeputationRAT(String yrCode,
				String month, String treasuryyno, String year,
				String treasuryDDOCode) {
			List temp = null;
		...
		public String[] getEmployeeCountDdoregNsdlForDeputationRAT(String yrCode,
				String month, String treasuryyno, String year,
				String treasuryDDOCode) {
			List empLst = null;
			List lLstReturnList1 = null;
		...
		public String[] getEmployeeListDdoregNsdlDeputationRAT(String yrCode,
				String month, String treasuryyno, String year,
				String treasuryDDOCode) {
			List empLst = null;
			List lLstReturnList1 = null;
		...
		public HashMap getEmployeeCountDdoregNsdlForDeputationMapRAT(String yrCode,
				String month, String treasuryyno, String year,
				String treasuryDDOCode) {
			List empLst = null;
			List lLstReturnList1 = null;
		...
		public HashMap getEmployeeListDdoregNsdlDeputationMapRAT(String yrCode,
				String month, String treasuryyno, String year,
				String treasuryDDOCode) {
			List empLst = null;
			List lLstReturnList1 = null;
		...
		public String getEmployeeContribTypeRAT(String month, String pranNo,String year) {
			List empLst = null;
			String flag = "C";

			StringBuilder sb = new StringBuilder();
			try {
				sb.append(" SELECT    sd.SD_PRAN_NO,  bh.YEAR,    bh.MONTH    FROM RAT_NSDL_SD_DTLS sd    inner join RAT_NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME ");
				sb.append(" and bh.RAT_STATUS <>-1    and bh.YEAR=" + year
						+ " and bh.MONTH=" + month + " and ");
				sb.append(" sd.SD_PRAN_NO = '" + pranNo + "'   ");
		...
		public List getAllDataDeputationRAT(String yrCode, String month,
				String strLocationCode) throws Exception {
			List contrList = null;
			Query lQuery = null;
			StringBuilder lSBQuery = null;
			try {
				...
				lSBQuery.append("  left outer join ifms.RAT_NSDL_BILL_DTLS nsdl on nsdl.FILE_NAME=bh.FILE_NAME  and nsdl.BILL_STATUS <> -1  where bh.MONTH='"
						...
						+ "and bh.file_name like '"
						+ strLocationCode
						+ "%D' and bh.RAT_STATUS <> -1 order by bh.file_name ");
		...
		public List getAllDataDeputationRATF(String yrCode, String month,
				String strLocationCode) throws Exception {
			List contrList = null;
			Query lQuery = null;
			StringBuilder lSBQuery = null;
			try {
				lSBQuery = new StringBuilder();
				lSBQuery.append(" SELECT distinct bh.FILE_NAME,bh.BH_EMP_AMOUNT,bh.BH_EMPLR_AMOUNT,NVL(cast(nsdl.BILL_ID as varchar(20)),'NA'),NVL(cast(nsdl.AUTH_NUMBER as varchar(20)),'NA') , decode(nsdl.BILL_STATUS,0,'PayBill Generated',1,'Paybill Approved',2,'Bill Rejected by Beams',3,'Bill Authorized by BEAMS','Paybill Not Generated')  , NVL(bh.TRANSACTION_ID,'-') ,   decode(bh.file_status,0,'File not Validated',1,'File is validated',2,'File is rejected',3,'File has been modified by User',5,'File has been sent to NSDL',11,'Transaction Id Updated',8,'Transaction Id Lapsed') ,nsdl.BILL_STATUS,bh.file_status,decode(NSDL_RESPONSE_HTML,null,1,2),nsdl.voucher_no,to_char(nsdl.VOUCHER_DATE,'dd/mm/yyyy') FROM RAT_NSDL_BH_DTLS bh   ");
				lSBQuery.append("  left outer join ifms.RATF_NSDL_BILL_DTLS nsdl on nsdl.FILE_NAME=bh.FILE_NAME  and nsdl.BILL_STATUS <> -1  where bh.MONTH='"
						+ month
						+ "' and bh.YEAR= '"
						+ yrCode
						...
						+ "and bh.file_name like '"
						+ strLocationCode
						+ "%D' and bh.STATUS not in(-1,9) order by bh.file_name ");
		...
		public List getDHDataDeputationRATF(String fileNumber) {
			List lLstReturnList = null;
			StringBuilder sb = new StringBuilder();
			sb.append(" SELECT SR_NO||'^'||HEADER_NAME||'^'||DH_NO||'^'||DH_COL2||'^'||DH_DDO_REG_NO||'^'||BH_SD_COUNT||'^'||DH_EMPLR_AMOUNT||'^'||DH_EMP_AMOUNT||'^^',DH_DDO_REG_NO FROM RAT_NSDL_DH_dtls ");
			sb.append(" where FILE_NAME='" + fileNumber+ "'  order by SR_NO asc");
		...
		public List getSDDtlsDeputationRATF(String fileNumber, String ddoRegNo) {
			List lLstReturnList = null;
			StringBuilder sb = new StringBuilder();
			sb.append(" SELECT SR_NO||'^'||HEADER_NAME||'^'||SD_NO||'^'||SD_NO_2||'^'||SD_NO_3||'^'||SD_PRAN_NO||'^'||SD_EMPLR_AMOUNT||'^'||SD_EMP_AMOUNT||'^'||'^'||SD_TOTAL_AMT||'^'||SD_STATUS||'^'||SD_REMARK||'^' FROM RAT_NSDL_SD_DTLS  ");
			sb.append(" where   FILE_NAME='" + fileNumber + "' and DDO_REG_NO='"
		...
		//////$tPAOBATCHSTART
public List getDdoWiseTotalAmtPAO(Long yearId, Long monthId,String strLocationCode, int flag, String ifBatch) {
			
			List lLstReturnList = null;
			StringBuilder sb = new StringBuilder();
			try {
				sb.append(" SELECT ddo.DDO_CODE,mstemp.PRAN_NO,sum(paybill.GROSS_AMT) as GROSS_AMT ,sum(paybill.NET_TOTAL) as NET_TOTAL ,sum(paybill.DCPS+paybill.DCPS_PAY+paybill.DCPS_DELAY+paybill.DCPS_DA+paybill.DCPS_PAY_DIFF) as employye, ");
				sb.append("sum(paybill.DED_ADJUST+nvl(paybill.emplr_contri_arrears,0)+nvl(paybill.NPS_EMPLR_DIFFERENCE_ADJ,0)) as DED_ADJUST,reg.ddo_reg_no ");//$tC
				sb.append("FROM PAYBILL_HEAD_MPG head   ");
				sb.append("inner join NSDL_PAYBILL_DATA paybill on paybill.PAYBILL_GRP_ID =head.PAYBILL_ID ");
				sb.append("and paybill.DCPS+paybill.DCPS_PAY+paybill.DCPS_DELAY+paybill.DCPS_DA+paybill.DCPS_PAY_DIFF <=paybill.DED_ADJUST ");////PayArrearDiff $t 23-2-2021
				...
				sb.append("inner join mst_ddo_reg reg on reg.ddo_code = ddo.ddo_code  ");
				sb.append("inner join MST_DTO_REG dto on substr(dto.LOC_ID,1,2)=substr(ddo.ddo_code,1,2) ");
				sb.append("inner join CMN_LOCATION_MST loc on loc.LOC_ID=substr(ddo.DDO_CODE,1,4) inner join PAO_Contri_Batch pao on reg.DDO_REG_NO=pao.DDO_REG_NO ");
				sb.append("where head.PAYBILL_YEAR=" + yearId
						+ " and head.PAYBILL_MONTH=" + monthId
						+ "  and substr(ddo.ddo_code,1,2)='" + strLocationCode.substring(0, 2)
						+ "' and head.APPROVE_FLAG=1 ");/////$t KR
				
				sb.append(" and pao.BATCH='"+ifBatch.trim()+"' and pao.IS_ACTIVE='1' and mstemp.PRAN_NO is not null and mstemp.PRAN_ACTIVE=1 and mstemp.DCPS_OR_GPF='Y' group by ddo.DDO_CODE,mstemp.PRAN_NO,reg.ddo_reg_no  ");
	 ...
	 public List getDdoWiseTotalAmtSentToNSDLPAO(Long yearId, Long monthId,String strLocationCode, int flag, String ifBatch) {
			...
			try {
				...
				sb.append(" SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt FROM NSDL_SD_DTLS sd ");//,mst.ddo_code
				sb.append(" inner join NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME inner join PAO_Contri_Batch pao on sd.DDO_REG_NO=pao.DDO_REG_NO and bh.STATUS <>-1 ");
				sb.append(" and bh.YEAR=" + yearId + " and bh.MONTH=" + monthId+
						"  and bh.file_name like '" + strLocationCode.substring(0, 2) + "%' and bh.file_name not like '%D' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) and pao.BATCH='"+ifBatch.trim()+"' and pao.IS_ACTIVE='1' ");
				sb.append(" group by sd.SD_PRAN_NO,bh.YEAR,bh.MONTH,sd.ddo_reg_no ");
	 ...
	 public List getEmployeeListNsdlPAO(String yrCode, String month,
				String treasuryyno, int flag, String paoBatch) throws Exception {// $t 2019 union all
																// separated.
	...
	////$t 2020 17-1 year 2020 n month jan added ||yrCode.equals("2020"))
			if ((yrCode.equals("2019") && (month.equals("10")|| month.equals("11") || month.equals("9")||month.equals("12")))
				...
				try {
					...
					sb.append(" and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.APPROVE_FLAG=1 and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' ");////$t emp.PRAN_ACTIVE=1
					sb.append(" group by  emp.EMP_NAME,emp.DCPS_ID,emp.PRAN_NO,loc.loc_name,dto.dto_reg_no,reg.ddo_reg_no ) a left outer join ");
					sb.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH ,sd.ddo_reg_no FROM NSDL_SD_DTLS sd ");
					sb.append(" inner join NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME inner join PAO_Contri_Batch pao on sd.DDO_REG_NO=pao.DDO_REG_NO and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' and bh.STATUS <>-1 ");
					//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
					sb.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month + 
							" and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and bh.file_name not like '%D' and sd.SD_REMARK like 'Contribution for%' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");//////$t29Mar2022////$t KR //+ " and bh.file_name like '" + treasuryyno + "%'  "); /////$t 25-3-2021
					/*}else{
					...
					sb1.append("  inner join mst_ddo_reg reg on reg.ddo_code = ddo.ddo_code  ");
					sb1.append("  inner join MST_DTO_REG dto on substr(dto.LOC_ID,1,2)=substr(ddo.ddo_code,1,2) ");
					sb1.append("  inner join CMN_LOCATION_MST loc on loc.LOC_ID=substr(ddo.DDO_CODE,1,4) inner join PAO_Contri_Batch pao on reg.DDO_REG_NO=pao.DDO_REG_NO ");
					//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
					sb1.append("  where head.PAYBILL_YEAR=" + yrCode
							+ " and head.PAYBILL_MONTH=" + month
							+ " and substr(ddo.ddo_code,1,2)=" + treasuryyno.substring(0,2) + " ");////$t KR 18-12-2020
					...
					sb1.append("  and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.APPROVE_FLAG=1 and (cast((nvl(paybill.emplr_contri_arrears,0)) as double) <> 0  or cast((nvl(paybill.NPS_EMPLR_DIFFERENCE_ADJ,0)) as double) <> 0) and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' ");////$tC
					sb1.append("  group by  emp.EMP_NAME,emp.DCPS_ID,emp.PRAN_NO,loc.loc_name,dto.dto_reg_no,reg.ddo_reg_no ) a left outer join ");
					sb1.append("  (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH ,sd.ddo_reg_no FROM NSDL_SD_DTLS sd ");
					sb1.append("  inner join NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME inner join PAO_Contri_Batch pao on sd.DDO_REG_NO=pao.DDO_REG_NO and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' and bh.STATUS <>-1 ");
					//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
					sb1.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
							" and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");////$t29Mar2022 and sd.SD_REMARK like '4 Per Contribution%'
					/*}else{
				...
				try {
					...
					sb.append(" and emp.PRAN_NO is not null and emp.PRAN_ACTIVE=1 and emp.REG_STATUS=1 and head.APPROVE_FLAG=1 and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' ");
					sb.append(" group by  emp.EMP_NAME,emp.DCPS_ID,emp.PRAN_NO,loc.loc_name,dto.dto_reg_no,reg.ddo_reg_no ) a left outer join ");
					sb.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH ,sd.ddo_reg_no FROM NSDL_SD_DTLS sd ");
					sb.append(" inner join NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME inner join PAO_Contri_Batch pao on sd.DDO_REG_NO=pao.DDO_REG_NO and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' and bh.STATUS <>-1 ");
					sb.append("  and bh.YEAR=" + yrCode + " and bh.MONTH=" + month
		...
		public Long getDDoRegCountPAO(String yrCode, String month, String treasuryyno,
				int flag, String paoBatch) {
			List temp = null;
			Long regCount = null;
		////$t 2020 17-1 year 2020 n month jan added
			if ((yrCode.equals("2019") && (month.equals("10")|| month.equals("11") || month.equals("9")||month.equals("12")))
				...
				Strbld1.append("inner join mst_ddo_reg reg on reg.ddo_code = ddo.ddo_code  ");
				Strbld1.append("inner join MST_DTO_REG dto on substr(dto.LOC_ID,1,2)=substr(ddo.ddo_code,1,2) ");
				Strbld1.append("inner join CMN_LOCATION_MST loc on loc.LOC_ID=substr(ddo.DDO_CODE,1,4) inner join PAO_Contri_Batch pao on reg.DDO_REG_NO=pao.DDO_REG_NO ");
				Strbld1.append(" where head.PAYBILL_YEAR='" + yrCode
						+ "' and head.PAYBILL_MONTH='" + month
						+ "' and substr(ddo.ddo_code,1,2)='" + treasuryyno.substring(0, 2)
						+ "' and head.APPROVE_FLAG=1 and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' ");////$t KR 18-12-2020
				
				Strbld1.append(" and mstemp.PRAN_NO is not null and mstemp.PRAN_ACTIVE=1 and mstemp.DCPS_OR_GPF='Y' and mstemp.REG_STATUS=1 group by ddo.DDO_CODE,mstemp.PRAN_NO,reg.ddo_reg_no ,head.LOC_ID  ) a left outer join ");
				Strbld1.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM NSDL_SD_DTLS sd  ");
				Strbld1.append(" inner join NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME inner join PAO_Contri_Batch pao on sd.DDO_REG_NO=pao.DDO_REG_NO and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' and bh.STATUS <>-1 ");
				Strbld1.append("\tand bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
						" and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and bh.file_name not like '%D' and sd.SD_REMARK like 'Contribution for%' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");//////$t29Mar2022////$t KR //+ " and bh.file_name like '" + treasuryyno + "%'  "); /////$t  25-3-2021
				Strbld1.append(" group by sd.SD_PRAN_NO,bh.YEAR,bh.MONTH,sd.ddo_reg_no ) b on b.SD_PRAN_NO=a.PRAN_NO and b.ddo_reg_no=a.ddo_reg_no where a.employye-cast(nvl(b.sd_amnt,0) as double) >0 and a.DED_ADJUST-cast(nvl(b.sd_emplr_amnt,0) as double) >0 ");
	           //$t 2019 4/11
				...
				Strbld2.append("inner join mst_ddo_reg reg on reg.ddo_code = ddo.ddo_code  ");
				Strbld2.append("inner join MST_DTO_REG dto on substr(dto.LOC_ID,1,2)=substr(ddo.ddo_code,1,2) ");
				Strbld2.append("inner join CMN_LOCATION_MST loc on loc.LOC_ID=substr(ddo.DDO_CODE,1,4) inner join PAO_Contri_Batch pao on reg.DDO_REG_NO=pao.DDO_REG_NO ");
				//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
				Strbld2.append(" where head.PAYBILL_YEAR='" + yrCode
						+ "' and head.PAYBILL_MONTH='" + month
						+ "' and substr(ddo.ddo_code,1,2)='" + treasuryyno.substring(0,2)
				...
				Strbld2.append(" and mstemp.PRAN_NO is not null and mstemp.PRAN_ACTIVE=1 and mstemp.DCPS_OR_GPF='Y' and mstemp.REG_STATUS=1 and (cast((nvl(paybill.emplr_contri_arrears,0)) as double) <> 0  or cast((nvl(paybill.NPS_EMPLR_DIFFERENCE_ADJ,0)) as double) <> 0) group by ddo.DDO_CODE,mstemp.PRAN_NO,reg.ddo_reg_no ,head.LOC_ID  ) a left outer join ");////$tC
				Strbld2.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM NSDL_SD_DTLS sd  ");
				Strbld2.append(" inner join NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME inner join PAO_Contri_Batch pao on sd.DDO_REG_NO=pao.DDO_REG_NO and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' and bh.STATUS <>-1 ");
				//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
				Strbld2.append("\tand bh.YEAR=" + yrCode + " and bh.MONTH=" + month+ 
						" and bh.file_name like '" + treasuryyno.substring(0,2) + "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");////$t29Mar2022////$t KR //+ " and bh.file_name like '" + treasuryyno + "%'  ");
				/*}else{
				...
				Strbld.append("inner join mst_ddo_reg reg on reg.ddo_code = ddo.ddo_code  ");
				Strbld.append("inner join MST_DTO_REG dto on substr(dto.LOC_ID,1,2)=substr(ddo.ddo_code,1,2) ");
				Strbld.append("inner join CMN_LOCATION_MST loc on loc.LOC_ID=substr(ddo.DDO_CODE,1,4) inner join PAO_Contri_Batch pao on reg.DDO_REG_NO=pao.DDO_REG_NO ");
				//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
				Strbld.append(" where head.PAYBILL_YEAR='" + yrCode
						+ "' and head.PAYBILL_MONTH='" + month
						+ "' and substr(ddo.ddo_code,1,2)='" + treasuryyno.substring(0,2)
				...
				Strbld.append(" and mstemp.PRAN_NO is not null and mstemp.PRAN_ACTIVE=1 and mstemp.DCPS_OR_GPF='Y' and mstemp.REG_STATUS=1 group by ddo.DDO_CODE,mstemp.PRAN_NO,reg.ddo_reg_no ,head.LOC_ID  ) a left outer join ");
				Strbld.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM NSDL_SD_DTLS sd  ");
				Strbld.append(" inner join NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME inner join PAO_Contri_Batch pao on sd.DDO_REG_NO=pao.DDO_REG_NO and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' and bh.STATUS <>-1 ");
				//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
				Strbld.append("\tand bh.YEAR=" + yrCode + " and bh.MONTH=" + month
						+ " and bh.file_name like '" + treasuryyno.substring(0, 2) + "%' and bh.file_name not like '%D' and sd.SD_REMARK like 'Contribution for%' and cast(sd.SD_EMP_AMOUNT as bigint) <= cast(sd.SD_EMPlr_AMOUNT as bigint) ");//////$t29Mar2022////$t KR /////$t  25-3-2021
				/*}else{
		...
		public List getEmployeeContriTotalListPAO(String yrCode, String month,
				String treasuryyno, int flag, String paoBatch) {
		...
		////$t 2020 17-1 year 2020 n month jan added
			...
			Strbld.append(" where head.PAYBILL_YEAR=" + yrCode
					+ " and head.PAYBILL_MONTH=" + month
					+ "  and substr(ddo.ddo_code,1,2)='" + treasuryyno.substring(0,2) + "' and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' ");////$t KR 18-12-2020
			/*}else{
			Strbld.append(" where head.PAYBILL_YEAR=" + yrCode
					+ " and head.PAYBILL_MONTH=" + month
					+ "  and substr(ddo.ddo_code,1,4)='" + treasuryyno + "' ");	
		...
		public String[] getEmployeeCountDdoregNsdlPAO(String yrCode, String month,
				String treasuryyno, int flag, String paoBatch) {
			String[] empCountLst = new String[1];
			...
			if ((yrCode.equals("2019") && (month.equals("10")|| month.equals("11") || month.equals("9")||month.equals("12")))
				...
				try {
					...
					Strbld.append("where head.PAYBILL_YEAR='" + yrCode
							+ "' and head.PAYBILL_MONTH='" + month
							+ "'  and substr(ddo.ddo_code,1,2)='" + treasuryyno.substring(0,2)
							+ "' and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' ");////$t KR 18-12-2020
					/*}else{
					Strbld.append("where head.PAYBILL_YEAR='" + yrCode
							+ "' and head.PAYBILL_MONTH='" + month
							+ "'  and substr(ddo.ddo_code,1,4)='" + treasuryyno
					...
					SBQuery1.append(" inner join mst_ddo_reg reg on reg.ddo_code = ddo.ddo_code  ");
					SBQuery1.append(" inner join MST_DTO_REG dto on substr(dto.LOC_ID,1,2)=substr(ddo.ddo_code,1,2)  ");
					SBQuery1.append(" inner join CMN_LOCATION_MST loc on loc.LOC_ID=substr(ddo.DDO_CODE,1,4) inner join PAO_Contri_Batch pao on reg.DDO_REG_NO=pao.DDO_REG_NO ");
					//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
					SBQuery1.append(" where head.PAYBILL_YEAR='" + yrCode
							+ "' and head.PAYBILL_MONTH='" + month
							+ "'  and substr(ddo.ddo_code,1,2)='" + treasuryyno.substring(0,2)
					...
					SBQuery1.append(" group by  emp.EMP_NAME,emp.DCPS_ID,emp.PRAN_NO,loc.loc_name,dto.dto_reg_no,reg.ddo_reg_no ) a left outer join ");
					SBQuery1.append(" (SELECT sd.SD_PRAN_NO,cast(sum(nvl(sd.SD_EMP_AMOUNT,0)) as double) as sd_amnt,cast(sum(nvl(sd.SD_EMPlr_AMOUNT,0)) as double) as sd_emplr_amnt ,bh.YEAR,bh.MONTH,sd.ddo_reg_no FROM NSDL_SD_DTLS sd ");
					SBQuery1.append(" inner join NSDL_BH_DTLS bh on bh.FILE_NAME=sd.FILE_NAME inner join PAO_Contri_Batch pao on sd.DDO_REG_NO=pao.DDO_REG_NO and pao.BATCH='"+paoBatch+"' and pao.IS_ACTIVE='1' and bh.STATUS <>-1 ");
					//if(treasuryyno.substring(0, 2).equals("12")||treasuryyno.substring(0, 2).equals("46")||treasuryyno.substring(0, 2).equals("23")||treasuryyno.substring(0, 2).equals("51")){////$t KR 5-1-2020
					SBQuery1.append(" and bh.YEAR=" + yrCode + " and bh.MONTH="
							+ month + " and bh.file_name like '" + treasuryyno.substring(0,2)
							+ "%' and (sd.SD_REMARK like '4 Per Contribution%' or sd.SD_REMARK like 'Less Employer Contribution%') ");////$t29Mar2022////$t KR
		...
		public String[] getEmployeeListDdoregNsdlPAO(String yrCode, String month,
				String treasuryyno, int flag, String paoBatch) throws HibernateException,
				SQLException {
			List empLst = null;
			String[] empDdoLst = new String[1];
