...
public interface ScheduleGenerationDAO extends GenericDao {
	...
	Double getOpeningBalForCurrMonth(String lStrGpfAccNo,String lStrsevaarthId, Long lLngMonthId, Long lLngYearId) throws Exception;  //swt
	...
	Double getAdvanceSanctionedForMonth(String lStrGpfAccNo,String lStrSevaarthId, Integer lLngMonthId, String lStrFinYear);   //swt 28/02/2020
	...
	String getStartDateOfFinancialYear(Long lLngFinYearId);

	List getMonthlyEmpListForPayroll(Long lLngBillgroupId, Long lLngMonthId, Long lLongYearId);

	MstGpfMonthly getMstGpfMonthlyObject(String lStrGpfAccNo, Long lLngMonthId, Long lLongYearId);
	
	Long getFinyearFromYearCode(String lStrFinYearCode);
	
	Date getSuperAnnDate(String currOff);

	Date getStartDateOfFinancialYear1(long longValue);
