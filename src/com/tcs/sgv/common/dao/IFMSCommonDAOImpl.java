...
public Long findTreasuryFilesCount(long locId, String roleId) {
	 Session session = getSession();
	    List list = null;
	    Long count = 0L;
...
public Long filesNotSendTO2DaysAlert(long locId, String roleId) {
	 Session session = getSession();
	    List list = null;
	    Long count = 0L;
...
public Long filesNotSendTO1DaysAlert(long locId, String roleId) {
	 Session session = getSession();
	    List list = null;
	    Long count = 0L;
