	...
	public static int partition(int[] array, int left, int right, int pivot) {
		while (left <= right) {
			while (array[left] < pivot) {
				//while use kele ahe becoz left pasun check kartat kiti value pivot peksa lahan ahet
				left++;
			}
			while (array[right] > pivot) {
				//while use kele ahe becoz right pasun check kartat kiti value pivot peksa mothya ahet
				right--;
			}
			if (left <= right) {
